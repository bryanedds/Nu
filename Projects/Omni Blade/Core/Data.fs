...
type NpcType =
    ...
    static member exists advents specialty =
        ...
        | NostrusNpc -> not (Set.contains MadTrixterDefeated advents)
        | RavelNpc | AdvenNpc | EildaenNpc -> true
        ...
        | Some tileMapChc ->
            ...
            | Choice3Of4 (_, tileMap, origin) ->
                ...
                | FieldRandom (_, _, _, _, _, _) ->
                    ...
                    | 0 -> if Gen.random1 3 <> 0 then Some WeakSpirit else Some NormalSpirit
                    | 1 -> if Gen.random1 3 = 0 then Some WeakSpirit else Some NormalSpirit
                    | 2 -> if Gen.random1 3 <> 0 then Some NormalSpirit else Some StrongSpirit
