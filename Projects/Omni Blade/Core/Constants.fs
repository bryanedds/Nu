...
module Constants =
    ...
    module Gameplay =
        ...
        let ItemLimitNormal = 9
        let ItemLimitHardcore = 5
    ...
    module Field =
        ...
        let WalkLengthScalar = 0.667f // NOTE: higher is longer distance to stronger spirits.
        let TreasureProbability = 0.667f
        let SpawnRoomPropId = -1 // NOTE: negative prop ids are reserved as hard-coded constants.
        let RecruitmentFees = [|200; 1000; 3000; 5000|]
    ...
    module Battle =
        ...
        let CriticalScalarTarget = 1.5f
        let CriticalScalarSplash = 2.0f
