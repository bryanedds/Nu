...
type MyGameDispatcher () =
    ...
    override this.Register (game, world) =
        ...
        // create movers query
        let movers = ecs.RegisterQuery (Query.byType<Position, Velocity> (Exclude.zero, Subquery.zero))

        // create shakers query
        let shakers = ecs.RegisterQuery (Query.byType<Position, Shake> (Exclude.zero, Subquery.zero))
        ...
        ecs.Subscribe EcsEvents.Update GlobalEvent $ fun _ _ -> movers.Iterate (fun position velocity world ->
        ...
        ecs.Subscribe EcsEvents.Update GlobalEvent $ fun _ _ -> shakers.Iterate (fun position shake world ->
