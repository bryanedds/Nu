...
type MyGameDispatcher () =
    ...
    override this.Register (game, world) =
        ...
        let positions = // 25,000 entities (goal: 60FPS, current 60FPS)
...
type MmccGameDispatcher () =
    inherit GameDispatcher<Intss, Message, Command> (Intss.init 105) // 11,025 MMCC entities (goal: 60FPS, current: 59FPS)
