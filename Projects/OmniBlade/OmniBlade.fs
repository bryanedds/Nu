    ...
    type OmniBladeDispatcher () =
        ...
        override this.Content (_, _) =
            ...
            [// splash
             ...
             Content.screenFromGroupFile Simulants.Intro5.Screen.Name (Nu.Splash (Constants.Intro.Dissolve, Constants.Intro.Splash, Some Assets.Gui.IntroSong, Some Simulants.Field.Screen)) Assets.Gui.Intro5GroupFilePath]