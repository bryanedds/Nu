            ...
            [Content.staticSprite "Background"
             ...
             Content.panel "Panel"
                ...
                [Content.text "OmniBlade" [Entity.Text == "OmniBlade"; Entity.PerimeterCentered == true]
                 ...
                 Content.text "Pimen*" [Entity.Text == "Pimen"; Entity.PerimeterCentered == true]
                 Content.text "Selier the Shaper*" [Entity.Text == "Selier the Shaper"; Entity.PerimeterCentered == true]
                 Content.text "SzadiArt*" [Entity.Text == "SzadiArt"; Entity.PerimeterCentered == true]
                 ...
                 Content.text "Simon13666*" [Entity.Text == "Simon13666"; Entity.PerimeterCentered == true]
                 Content.text "SoundWorks12*" [Entity.Text == "SoundWorks12"; Entity.PerimeterCentered == true]
