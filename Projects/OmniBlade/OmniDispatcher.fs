...
module OmniDispatcher =
    ...
    type Game with
        ...
        member this.Field =
            ...
            Lens.withValidateOpt (Some (fun world -> match this.Model.Get world with Field _ -> true | _ -> false))
        member this.Battle =
            this.Model |>
            Lens.bimapWorld
            ...
            Lens.withValidateOpt (Some (fun world -> match this.Model.Get world with Field field -> Option.isSome field.BattleOpt | _ -> false))
