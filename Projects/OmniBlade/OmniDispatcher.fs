...
module OmniDispatcher =
    ...
    type Game with
        ...
        member this.Field =
            ...
            Lens.refine (fun world -> match this.GetModel world with Field _ -> true | _ -> false)
        member this.Battle =
            this.Model |>
            Lens.bimapWorld
            ...
            Lens.refine (fun world -> match this.GetModel world with Field field -> Option.isSome field.BattleOpt | _ -> false)
