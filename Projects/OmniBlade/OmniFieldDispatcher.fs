            ...
            [// scene layer
             Content.layer Simulants.Field.Scene.Layer.Name []
                ...
                [// backdrop sprite
                 ...
                 Content.staticSprite Simulants.Field.Scene.TransitionFade.Name
                 ...
                 // interact button
                 Content.button Simulants.Field.Scene.Interact.Name
                 ...
                 // dialog
                 Dialog.content Simulants.Field.Scene.Dialog.Name
                 ...
                 // team
                 Content.panel Simulants.Field.Submenu.Team.Name
                 ...
                 // item
                 Content.panel Simulants.Field.Submenu.Item.Name
                    [Entity.Position == v2 -448.0f -256.0f; Entity.Elevation == Constants.Field.GuiElevation; Entity.Size == v2 896.0f 512.0f
                     Entity.LabelImage == Assets.Gui.DialogXXLImage
                 ...
                 // use
                 Content.panel Simulants.Field.Submenu.Use.Name
                 ...
                 // shop
                 Content.panel Simulants.Field.Shop.Panel.Name
                    [Entity.Position == v2 -448.0f -256.0f; Entity.Elevation == Constants.Field.GuiElevation; Entity.Size == v2 896.0f 512.0f
                     Entity.LabelImage == Assets.Gui.DialogXXLImage
