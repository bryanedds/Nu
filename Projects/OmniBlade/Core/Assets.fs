...
module Assets =
    ...
    module Gui =
        ...
        let IntroSong = { FadeInTime = 0.0f; FadeOutTime = 1.5f; StartTime = 0.0f; Volume = Constants.Audio.SongVolumeDefault; Song = asset<Song> PackageName "Intro" }
    ...
    module Field =
        ...
        let FieldSong = { FadeInTime = 0.0f; FadeOutTime = Constants.Audio.FadeOutTimeDefault; StartTime = 0.0f; Volume = Constants.Audio.SongVolumeDefault; Song = asset<Song> PackageName "Field" }
