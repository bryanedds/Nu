...
module Assets =
    ...
    module Field =
        ...
        let SpiritChestImage = asset<Image> PackageName "SpiritChest"
        ...
        let GarrouAnimationSheet = asset<Image> PackageName "Garrou"
        ...
        let GarrouPortraitImage = asset<Image> PackageName "GarrouPortrait"
