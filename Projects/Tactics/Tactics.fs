    ...
    type TacticsDispatcher () =
        ...
        override this.Content (_, _) =
            ...
            [// splash
             ...
             Content.screenFromGroupFile Simulants.Intro5.Screen.Name (WorldTypes.Splash (Constants.Intro.Dissolve, Constants.Intro.Splash, Some Assets.Gui.IntroSong, Simulants.Atlas.Screen)) Assets.Gui.Intro5GroupFilePath]