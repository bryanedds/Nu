    ...
    type TacticsDispatcher () =
        ...
        override this.Content (_, _) =
            ...
            [// splash
             ...
             // pick
             Content.screenWithGroupFromFile Simulants.Pick.Name (Dissolve ({ Constants.Gui.Dissolve with OutgoingTime = UpdateTime 90L }, Some Assets.Gui.TitleSong)) Assets.Gui.PickGroupFilePath [] []
