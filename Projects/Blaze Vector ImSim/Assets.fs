...
module Assets =
    ...
    module Gui =
        ...
        let PackageName = "Gui"
        let MachinerySong = { SongDescriptor.defaultDescriptor with Song = asset PackageName "Machinery" }
    ...
    module Gameplay =
        ...
        let DeadBlazeSong = { SongDescriptor.defaultDescriptor with Volume = 2.0f; Song = asset PackageName "DeadBlaze" }
