...
module CharacterStateFacetModule =
    ...
    type Entity with
        ...
        member this.SetCharacterType (value : CharacterType) world = this.SetFast Property? ActivityState false false value world
        ...
        member this.SetActivityState (value : ActivityState) world = this.SetFast Property? ActivityState false false value world
        ...
        member this.SetHitPoints (value : int) world = this.SetFast Property? HitPoints false false value world
        ...
        member this.SetSpecialPoints (value : int) world = this.SetFast Property? SpecialPoints false false value world
        ...
        member this.SetPowerBuff (value : single) world = this.SetFast Property? PowerBuff false false value world
        ...
        member this.SetShieldBuff (value : single) world = this.SetFast Property? ShieldBuff false false value world
        ...
        member this.SetMindBuff (value : single) world = this.SetFast Property? MindBuff false false value world
        ...
        member this.SetCounterBuff (value : single) world = this.SetFast Property? CounterBuff false false value world
        ...
        member this.SetStatuses (value : StatusType Set) world = this.SetFast Property? Statuses false false value world
        ...
        member this.SetEquippedWeapon (value : WeaponType option) world = this.SetFast Property? EquippedWeapon false false value world
        ...
        member this.SetEquippedArmor (value : ArmorType option) world = this.SetFast Property? EquippedArmor false false value world
        ...
        member this.SetEquippedRelics (value : RelicType list) world = this.SetFast Property? EquippedRelics false false value world
        ...
        member this.SetControlType (value : ControlType) world = this.SetFast Property? ControlType false false value world
...
module CharacterAnimationFacetModule =
    ...
    type Entity with
        ...
        member this.SetCharacterAnimationState (value : CharacterAnimationState) world = this.SetFast Property? CharacterAnimationState false false value world
        ...
        member this.SetCharacterAnimationSheet (value : Image AssetTag) world = this.SetFast Property? CharacterAnimationSheet false false value world
