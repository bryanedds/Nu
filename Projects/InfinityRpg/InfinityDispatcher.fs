...
type InfinityDispatcher () =
    ...
    static let createTitle world =
        let world = World.createDissolveScreenFromGroupFile None (Some Simulants.Title.ScreenName) Constants.InfinityRpg.DissolveData Assets.TitleGroupFilePath world |> snd
    ...
    static let createCredits world =
        let world = World.createDissolveScreenFromGroupFile None (Some Simulants.Credits.ScreenName) Constants.InfinityRpg.DissolveData Assets.CreditsGroupFilePath world |> snd
    ...
    static let createGameplay world =
        let world = World.createDissolveScreenFromGroupFile<GameplayDispatcher> None (Some Simulants.Gameplay.ScreenName) Constants.InfinityRpg.DissolveData Assets.HudGroupFilePath world |> snd
