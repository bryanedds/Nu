    ...
    override this.Command (_, command, _, world) =
        ...
        | Update ->
            ...
            if World.isKeyboardKeyDown KeyboardKey.Left world then
                let world =
                    ...
                    then World.applyBodyForce (v3 -800.0f 0.0f 0.0f) (Some v3Zero) bodyId world
                    else World.applyBodyForce (v3 -200.0f 0.0f 0.0f) (Some v3Zero) bodyId world
                just world
        ...
        | Jump ->
            ...
            if world.Advancing && World.getBodyGrounded bodyId world then
                let world = World.applyBodyLinearImpulse (v3 0.0f 800.0f 0.0f) (Some v3Zero) bodyId world
