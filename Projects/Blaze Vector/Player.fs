    ...
    override this.Command (player, command, entity, world) =
        ...
        | UpdateCommand ->
            if player.Alive then
                ...
                let world = World.applyBodyForce force (Some v3Zero) bodyId world
                just world
            else just world

        | Jump ->
            let world = World.applyBodyLinearImpulse (v3 0.0f JumpForce 0.0f) (Some v3Zero) (entity.GetBodyId world) world
        ...
        | Shoot ->
            ...
            let world = World.applyBodyLinearImpulse (v3 BulletForce 0.0f 0.0f) (Some v3Zero) (bullet.GetBodyId world) world
