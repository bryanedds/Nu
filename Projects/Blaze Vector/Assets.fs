...
module Assets =
    ...
    module Gui =
        ...
        let PackageName = "Gui"
        let MachinerySong = { FadeInTime = GameTime.zero; FadeOutTime = Constants.Audio.FadeOutTimeDefault; StartTime = GameTime.zero; Volume = Constants.Audio.SongVolumeDefault; RepeatLimitOpt = None; Song = asset<Song> PackageName "Machinery" }
    ...
    module Gameplay =
        ...
        let DeadBlazeSong = { FadeInTime = GameTime.zero; FadeOutTime = Constants.Audio.FadeOutTimeDefault; StartTime = GameTime.zero; Volume = Constants.Audio.SongVolumeDefault * 2.0f; RepeatLimitOpt = None; Song = asset<Song> PackageName "DeadBlaze" }
