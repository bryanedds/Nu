...
module PlayerModule =
    ...
    type PlayerDispatcher () =
        ...
        let shootBullet playerAddress (player : Entity) world =
            let bulletAddress = Address.allButLast playerAddress @+ [astring <| Core.makeId ()]
...
module StageScreenModule =
    ...
    type StageScreenDispatcher () =
        ...
        let handleStartPlay event world =
            ...
            let sectionDescriptors =
                [for i in 0 .. SectionCount do
                    ...
                    yield makeSectionFromFile sectionFilePaths.[sectionFilePathIndex] (SectionName + astring i) (xShift * single i) world]
        ...
        let handleStopPlay event world =
            let address = Event.unwrapA event
            let sectionNames = [for i in 0 .. SectionCount do yield SectionName + astring i]
