...
module BlazeProgression =
    ...
    let addTitleScreen world =
        ...
        let world = World.subscribe4 GameAddress SelectTitleEventAddress handlePlaySongMachinery world
        ...
        let world = World.subscribe4 GameAddress ClickTitlePlayEventAddress handlePlayStage world
    ...
    let addStageScreen world =
        let world = snd <| World.addDissolveScreenFromFile false typeof<StageScreenDispatcher>.Name StageAddress StageGroupFilePath DissolveData world
