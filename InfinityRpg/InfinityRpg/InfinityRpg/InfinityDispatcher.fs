...
type InfinityDispatcher () =
    ...
    static let createTitle world =
        let world = snd ^ World.createDissolveScreenFromGroupFile false Constants.InfinityRpg.DissolveData typeof<ScreenDispatcher>.Name Constants.FilePaths.TitleGroup (Some Simulants.Title.ScreenName) world
    ...
    static let createCredits world =
        let world = snd ^ World.createDissolveScreenFromGroupFile false Constants.InfinityRpg.DissolveData typeof<ScreenDispatcher>.Name Constants.FilePaths.CreditsGroup (Some Simulants.Credits.ScreenName) world
    ...
    static let createGameplay world =
        let world = snd ^ World.createDissolveScreenFromGroupFile true Constants.InfinityRpg.DissolveData typeof<GameplayDispatcher>.Name Constants.FilePaths.HudGroup (Some Simulants.Gameplay.ScreenName) world
