...
void main()
{
    ...
    else if (lm2 == -1)
    {
        ...
        irradiance = texture(irradianceMaps[nonuniformEXT(lm1)], n).rgb;
    ...
    else
    {
        ...
        vec3 irradiance1 = texture(irradianceMaps[nonuniformEXT(lm1)], n).rgb;
        vec3 irradiance2 = texture(irradianceMaps[nonuniformEXT(lm2)], n).rgb;
