...
layout(binding = 13) uniform m0 { float lightShadowExponent; } lightShadowExponent;
layout(binding = 14) uniform n0 { float lightShadowDensity; } lightShadowDensity;
layout(binding = 15) uniform o0 { float lightShadowSampleScalar; } lightShadowSampleScalar;
...
layout(set = 1, binding = 35) uniform sampler2D albedoTexture[];
layout(set = 1, binding = 36) uniform sampler2D roughnessTexture[];
layout(set = 1, binding = 37) uniform sampler2D metallicTexture[];
layout(set = 1, binding = 38) uniform sampler2D ambientOcclusionTexture[];
layout(set = 1, binding = 39) uniform sampler2D emissionTexture[];
layout(set = 1, binding = 40) uniform sampler2D normalTexture[];
layout(set = 1, binding = 41) uniform sampler2D heightTexture[];
layout(binding = 42) uniform sampler2D depthTexture;
layout(binding = 43) uniform sampler2D colorTexture;
layout(binding = 44) uniform sampler2D brdfTexture;
layout(binding = 45) uniform samplerCube irradianceMap;
layout(binding = 46) uniform samplerCube environmentFilterMap;
layout(set = 1, binding = 47) uniform samplerCube irradianceMaps[LIGHT_MAPS_MAX][];
layout(set = 1, binding = 48) uniform samplerCube environmentFilterMaps[LIGHT_MAPS_MAX][];
layout(set = 1, binding = 49) uniform sampler2DArray shadowTextures[];
layout(set = 1, binding = 50) uniform samplerCube shadowMaps[SHADOW_MAPS_MAX][];
layout(set = 1, binding = 51) uniform sampler2DArray shadowCascades[SHADOW_CASCADES_MAX][];
layout(set = 1, binding = 52) uniform i1 { vec3 lightMapOrigins[LIGHT_MAPS_MAX]; } lightMapOrigins[];
layout(set = 1, binding = 53) uniform j1 { vec3 lightMapMins[LIGHT_MAPS_MAX]; } lightMapMins[];
layout(set = 1, binding = 54) uniform k1 { vec3 lightMapSizes[LIGHT_MAPS_MAX]; } lightMapSizes[];
layout(set = 1, binding = 55) uniform l1 { vec3 lightMapAmbientColors[LIGHT_MAPS_MAX]; } lightMapAmbientColors[];
layout(set = 1, binding = 56) uniform m1 { float lightMapAmbientBrightnesses[LIGHT_MAPS_MAX]; } lightMapAmbientBrightnesses[];
layout(set = 1, binding = 57) uniform n1 { int lightMapsCount; } lightMapsCount[];
layout(set = 1, binding = 58) uniform o1 { float lightMapSingletonBlendMargin; } lightMapSingletonBlendMargin[];
layout(set = 1, binding = 59) uniform p1 { vec3 lightOrigins[LIGHTS_MAX]; } lightOrigins[];
layout(set = 1, binding = 60) uniform q1 { vec3 lightDirections[LIGHTS_MAX]; } lightDirections[];
layout(set = 1, binding = 61) uniform r1 { vec3 lightColors[LIGHTS_MAX]; } lightColors[];
layout(set = 1, binding = 62) uniform s1 { float lightBrightnesses[LIGHTS_MAX]; } lightBrightnesses[];
layout(set = 1, binding = 63) uniform t1 { float lightAttenuationLinears[LIGHTS_MAX]; } lightAttenuationLinears[];
layout(set = 1, binding = 64) uniform u1 { float lightAttenuationQuadratics[LIGHTS_MAX]; } lightAttenuationQuadratics[];
layout(set = 1, binding = 65) uniform v1 { float lightCutoffs[LIGHTS_MAX]; } lightCutoffs[];
layout(set = 1, binding = 66) uniform w1 { int lightTypes[LIGHTS_MAX]; } lightTypes[];
layout(set = 1, binding = 67) uniform x1 { float lightConeInners[LIGHTS_MAX]; } lightConeInners[];
layout(set = 1, binding = 68) uniform y1 { float lightConeOuters[LIGHTS_MAX]; } lightConeOuters[];
layout(set = 1, binding = 69) uniform z1 { int lightDesireFogs[LIGHTS_MAX]; } lightDesireFogs[];
layout(set = 1, binding = 70) uniform a2 { int lightShadowIndices[LIGHTS_MAX]; } lightShadowIndices[];
layout(set = 1, binding = 71) uniform b2 { int lightsCount; } lightsCount[];
layout(binding = 72) uniform c2 { float shadowNear; } shadowNear; // NOTE: currently unused.
layout(set = 1, binding = 73) uniform d2 { mat4 shadowMatrices[SHADOW_TEXTURES_MAX + SHADOW_CASCADES_MAX * SHADOW_CASCADE_LEVELS]; } shadowMatrices[];
