...
module Constants =
    ...
    module Gaia =
        ...
        let [<Literal>] PropertyValueStrMemoCapacity = 131072 // NOTE: this is a somewhat arbitrary number that works well for OmniBlade, but it's unknown how well it will hold up for more complex games.
