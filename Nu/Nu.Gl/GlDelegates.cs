...
namespace Nu
{
    ...
    partial class Gl
    {
        internal static partial class Delegates
        {
            ...
            internal delegate void BeginConditionalRender(UInt32 id, Nu.ConditionalRenderType mode);
            ...
            internal delegate void BeginQuery(Nu.QueryTarget target, UInt32 id);
            internal static BeginQuery glBeginQuery;
            internal delegate void EndQuery(Nu.QueryTarget target);
            internal static EndQuery glEndQuery;
            internal delegate void BeginQueryIndexed(Nu.QueryTarget target, UInt32 index, UInt32 id);
            internal static BeginQueryIndexed glBeginQueryIndexed;
            internal delegate void EndQueryIndexed(Nu.QueryTarget target, UInt32 index);
            internal static EndQueryIndexed glEndQueryIndexed;
            internal delegate void BeginTransformFeedback(Nu.BeginFeedbackMode primitiveMode);
            ...
            internal delegate void BindBuffer(Nu.BufferTarget target, UInt32 buffer);
            internal static BindBuffer glBindBuffer;
            internal delegate void BindBufferBase(Nu.BufferTarget target, UInt32 index, UInt32 buffer);
            ...
            internal delegate void BindBuffersBase(Nu.BufferTarget target, UInt32 first, Int32 count, UInt32[] buffers);
            internal static BindBuffersBase glBindBuffersBase;
            internal delegate void BindBuffersRange(Nu.BufferTarget target, UInt32 first, Int32 count, UInt32[] buffers, IntPtr[] offsets, IntPtr[] sizes);
            ...
            internal delegate void BindFramebuffer(Nu.FramebufferTarget target, UInt32 framebuffer);
            internal static BindFramebuffer glBindFramebuffer;
            internal delegate void BindImageTexture(UInt32 unit, UInt32 texture, Int32 level, Boolean layered, Int32 layer, Nu.BufferAccess access, Nu.PixelInternalFormat format);
            ...
            internal delegate void BindRenderbuffer(Nu.RenderbufferTarget target, UInt32 renderbuffer);
            ...
            internal delegate void BindTexture(Nu.TextureTarget target, UInt32 texture);
            ...
            internal delegate void BindTransformFeedback(Nu.NvTransformFeedback2 target, UInt32 id);
            ...
            internal delegate void BlendEquation(Nu.BlendEquationMode mode);
            internal static BlendEquation glBlendEquation;
            internal delegate void BlendEquationi(UInt32 buf, Nu.BlendEquationMode mode);
            internal static BlendEquationi glBlendEquationi;
            internal delegate void BlendEquationSeparate(Nu.BlendEquationMode modeRGB, Nu.BlendEquationMode modeAlpha);
            internal static BlendEquationSeparate glBlendEquationSeparate;
            internal delegate void BlendEquationSeparatei(UInt32 buf, Nu.BlendEquationMode modeRGB, Nu.BlendEquationMode modeAlpha);
            internal static BlendEquationSeparatei glBlendEquationSeparatei;
            internal delegate void BlendFunc(Nu.BlendingFactorSrc sfactor, Nu.BlendingFactorDest dfactor);
            internal static BlendFunc glBlendFunc;
            internal delegate void BlendFunci(UInt32 buf, Nu.BlendingFactorSrc sfactor, Nu.BlendingFactorDest dfactor);
            internal static BlendFunci glBlendFunci;
            internal delegate void BlendFuncSeparate(Nu.BlendingFactorSrc srcRGB, Nu.BlendingFactorDest dstRGB, Nu.BlendingFactorSrc srcAlpha, Nu.BlendingFactorDest dstAlpha);
            internal static BlendFuncSeparate glBlendFuncSeparate;
            internal delegate void BlendFuncSeparatei(UInt32 buf, Nu.BlendingFactorSrc srcRGB, Nu.BlendingFactorDest dstRGB, Nu.BlendingFactorSrc srcAlpha, Nu.BlendingFactorDest dstAlpha);
            internal static BlendFuncSeparatei glBlendFuncSeparatei;
            internal delegate void BlitFramebuffer(Int32 srcX0, Int32 srcY0, Int32 srcX1, Int32 srcY1, Int32 dstX0, Int32 dstY0, Int32 dstX1, Int32 dstY1, Nu.ClearBufferMask mask, Nu.BlitFramebufferFilter filter);
            internal static BlitFramebuffer glBlitFramebuffer;
            internal delegate void BlitNamedFramebuffer(UInt32 readFramebuffer, UInt32 drawFramebuffer, Int32 srcX0, Int32 srcY0, Int32 srcX1, Int32 srcY1, Int32 dstX0, Int32 dstY0, Int32 dstX1, Int32 dstY1, Nu.ClearBufferMask mask, Nu.BlitFramebufferFilter filter);
            internal static BlitNamedFramebuffer glBlitNamedFramebuffer;
            internal delegate void BufferData(Nu.BufferTarget target, IntPtr size, IntPtr data, Nu.BufferUsageHint usage);
            internal static BufferData glBufferData;
            internal delegate void NamedBufferData(UInt32 buffer, Int32 size, IntPtr data, Nu.BufferUsageHint usage);
            internal static NamedBufferData glNamedBufferData;
            internal delegate void BufferStorage(Nu.BufferTarget target, IntPtr size, IntPtr data, UInt32 flags);
            ...
            internal delegate void BufferSubData(Nu.BufferTarget target, IntPtr offset, IntPtr size, IntPtr data);
            ...
            internal delegate Nu.FramebufferErrorCode CheckFramebufferStatus(Nu.FramebufferTarget target);
            internal static CheckFramebufferStatus glCheckFramebufferStatus;
            internal delegate Nu.FramebufferErrorCode CheckNamedFramebufferStatus(UInt32 framebuffer, Nu.FramebufferTarget target);
            internal static CheckNamedFramebufferStatus glCheckNamedFramebufferStatus;
            internal delegate void ClampColor(Nu.ClampColorTarget target, Nu.ClampColorMode clamp);
            internal static ClampColor glClampColor;
            internal delegate void Clear(Nu.ClearBufferMask mask);
            internal static Clear glClear;
            internal delegate void ClearBufferiv(Nu.ClearBuffer buffer, Int32 drawbuffer, Int32[] value);
            internal static ClearBufferiv glClearBufferiv;
            internal delegate void ClearBufferuiv(Nu.ClearBuffer buffer, Int32 drawbuffer, UInt32[] value);
            internal static ClearBufferuiv glClearBufferuiv;
            internal delegate void ClearBufferfv(Nu.ClearBuffer buffer, Int32 drawbuffer, Single[] value);
            internal static ClearBufferfv glClearBufferfv;
            internal delegate void ClearBufferfi(Nu.ClearBuffer buffer, Int32 drawbuffer, Single depth, Int32 stencil);
            internal static ClearBufferfi glClearBufferfi;
            internal delegate void ClearNamedFramebufferiv(UInt32 framebuffer, Nu.ClearBuffer buffer, Int32 drawbuffer, Int32[] value);
            internal static ClearNamedFramebufferiv glClearNamedFramebufferiv;
            internal delegate void ClearNamedFramebufferuiv(UInt32 framebuffer, Nu.ClearBuffer buffer, Int32 drawbuffer, UInt32[] value);
            internal static ClearNamedFramebufferuiv glClearNamedFramebufferuiv;
            internal delegate void ClearNamedFramebufferfv(UInt32 framebuffer, Nu.ClearBuffer buffer, Int32 drawbuffer, Single[] value);
            internal static ClearNamedFramebufferfv glClearNamedFramebufferfv;
            internal delegate void ClearNamedFramebufferfi(UInt32 framebuffer, Nu.ClearBuffer buffer, Int32 drawbuffer, Single depth, Int32 stencil);
            internal static ClearNamedFramebufferfi glClearNamedFramebufferfi;
            internal delegate void ClearBufferData(Nu.BufferTarget target, Nu.SizedInternalFormat internalFormat, Nu.PixelInternalFormat format, Nu.PixelType type, IntPtr data);
            internal static ClearBufferData glClearBufferData;
            internal delegate void ClearNamedBufferData(UInt32 buffer, Nu.SizedInternalFormat internalFormat, Nu.PixelInternalFormat format, Nu.PixelType type, IntPtr data);
            internal static ClearNamedBufferData glClearNamedBufferData;
            internal delegate void ClearBufferSubData(Nu.BufferTarget target, Nu.SizedInternalFormat internalFormat, IntPtr offset, IntPtr size, Nu.PixelInternalFormat format, Nu.PixelType type, IntPtr data);
            internal static ClearBufferSubData glClearBufferSubData;
            internal delegate void ClearNamedBufferSubData(UInt32 buffer, Nu.SizedInternalFormat internalFormat, IntPtr offset, Int32 size, Nu.PixelInternalFormat format, Nu.PixelType type, IntPtr data);
            ...
            internal delegate void ClearTexImage(UInt32 texture, Int32 level, Nu.PixelInternalFormat format, Nu.PixelType type, IntPtr data);
            internal static ClearTexImage glClearTexImage;
            internal delegate void ClearTexSubImage(UInt32 texture, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, Nu.PixelInternalFormat format, Nu.PixelType type, IntPtr data);
            internal static ClearTexSubImage glClearTexSubImage;
            internal delegate Nu.ArbSync ClientWaitSync(IntPtr sync, UInt32 flags, UInt64 timeout);
            internal static ClientWaitSync glClientWaitSync;
            internal delegate void ClipControl(Nu.ClipControlOrigin origin, Nu.ClipControlDepth depth);
            ...
            internal delegate void CompressedTexImage1D(Nu.TextureTarget target, Int32 level, Nu.PixelInternalFormat internalFormat, Int32 width, Int32 border, Int32 imageSize, IntPtr data);
            internal static CompressedTexImage1D glCompressedTexImage1D;
            internal delegate void CompressedTexImage2D(Nu.TextureTarget target, Int32 level, Nu.PixelInternalFormat internalFormat, Int32 width, Int32 height, Int32 border, Int32 imageSize, IntPtr data);
            internal static CompressedTexImage2D glCompressedTexImage2D;
            internal delegate void CompressedTexImage3D(Nu.TextureTarget target, Int32 level, Nu.PixelInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth, Int32 border, Int32 imageSize, IntPtr data);
            internal static CompressedTexImage3D glCompressedTexImage3D;
            internal delegate void CompressedTexSubImage1D(Nu.TextureTarget target, Int32 level, Int32 xoffset, Int32 width, Nu.PixelFormat format, Int32 imageSize, IntPtr data);
            internal static CompressedTexSubImage1D glCompressedTexSubImage1D;
            internal delegate void CompressedTextureSubImage1D(UInt32 texture, Int32 level, Int32 xoffset, Int32 width, Nu.PixelInternalFormat format, Int32 imageSize, IntPtr data);
            internal static CompressedTextureSubImage1D glCompressedTextureSubImage1D;
            internal delegate void CompressedTexSubImage2D(Nu.TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 width, Int32 height, Nu.PixelFormat format, Int32 imageSize, IntPtr data);
            internal static CompressedTexSubImage2D glCompressedTexSubImage2D;
            internal delegate void CompressedTextureSubImage2D(UInt32 texture, Int32 level, Int32 xoffset, Int32 yoffset, Int32 width, Int32 height, Nu.PixelInternalFormat format, Int32 imageSize, IntPtr data);
            internal static CompressedTextureSubImage2D glCompressedTextureSubImage2D;
            internal delegate void CompressedTexSubImage3D(Nu.TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, Nu.PixelFormat format, Int32 imageSize, IntPtr data);
            internal static CompressedTexSubImage3D glCompressedTexSubImage3D;
            internal delegate void CompressedTextureSubImage3D(UInt32 texture, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, Nu.PixelInternalFormat format, Int32 imageSize, IntPtr data);
            internal static CompressedTextureSubImage3D glCompressedTextureSubImage3D;
            internal delegate void CopyBufferSubData(Nu.BufferTarget readTarget, Nu.BufferTarget writeTarget, IntPtr readOffset, IntPtr writeOffset, IntPtr size);
            ...
            internal delegate void CopyImageSubData(UInt32 srcName, Nu.BufferTarget srcTarget, Int32 srcLevel, Int32 srcX, Int32 srcY, Int32 srcZ, UInt32 dstName, Nu.BufferTarget dstTarget, Int32 dstLevel, Int32 dstX, Int32 dstY, Int32 dstZ, Int32 srcWidth, Int32 srcHeight, Int32 srcDepth);
            internal static CopyImageSubData glCopyImageSubData;
            internal delegate void CopyTexImage1D(Nu.TextureTarget target, Int32 level, Nu.PixelInternalFormat internalFormat, Int32 x, Int32 y, Int32 width, Int32 border);
            internal static CopyTexImage1D glCopyTexImage1D;
            internal delegate void CopyTexImage2D(Nu.TextureTarget target, Int32 level, Nu.PixelInternalFormat internalFormat, Int32 x, Int32 y, Int32 width, Int32 height, Int32 border);
            internal static CopyTexImage2D glCopyTexImage2D;
            internal delegate void CopyTexSubImage1D(Nu.TextureTarget target, Int32 level, Int32 xoffset, Int32 x, Int32 y, Int32 width);
            ...
            internal delegate void CopyTexSubImage2D(Nu.TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 x, Int32 y, Int32 width, Int32 height);
            ...
            internal delegate void CopyTexSubImage3D(Nu.TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 x, Int32 y, Int32 width, Int32 height);
            ...
            internal delegate void CreateQueries(Nu.QueryTarget target, Int32 n, UInt32[] ids);
            ...
            internal delegate UInt32 CreateShader(Nu.ShaderType shaderType);
            internal static CreateShader glCreateShader;
            internal delegate UInt32 CreateShaderProgramv(Nu.ShaderType type, Int32 count, String strings);
            internal static CreateShaderProgramv glCreateShaderProgramv;
            internal delegate void CreateTextures(Nu.TextureTarget target, Int32 n, UInt32[] textures);
            ...
            internal delegate void CullFace(Nu.CullFaceMode mode);
            ...
            internal delegate void DepthFunc(Nu.DepthFunction func);
            ...
            internal delegate void DrawArrays(Nu.BeginMode mode, Int32 first, Int32 count);
            internal static DrawArrays glDrawArrays;
            internal delegate void DrawArraysIndirect(Nu.BeginMode mode, IntPtr indirect);
            internal static DrawArraysIndirect glDrawArraysIndirect;
            internal delegate void DrawArraysInstanced(Nu.BeginMode mode, Int32 first, Int32 count, Int32 primcount);
            internal static DrawArraysInstanced glDrawArraysInstanced;
            internal delegate void DrawArraysInstancedBaseInstance(Nu.BeginMode mode, Int32 first, Int32 count, Int32 primcount, UInt32 baseinstance);
            internal static DrawArraysInstancedBaseInstance glDrawArraysInstancedBaseInstance;
            internal delegate void DrawBuffer(Nu.DrawBufferMode buf);
            internal static DrawBuffer glDrawBuffer;
            internal delegate void NamedFramebufferDrawBuffer(UInt32 framebuffer, Nu.DrawBufferMode buf);
            internal static NamedFramebufferDrawBuffer glNamedFramebufferDrawBuffer;
            internal delegate void DrawBuffers(Int32 n, Nu.DrawBuffersEnum[] bufs);
            internal static DrawBuffers glDrawBuffers;
            internal delegate void NamedFramebufferDrawBuffers(UInt32 framebuffer, Int32 n, Nu.DrawBufferMode[] bufs);
            internal static NamedFramebufferDrawBuffers glNamedFramebufferDrawBuffers;
            internal delegate void DrawElements(Nu.BeginMode mode, Int32 count, Nu.DrawElementsType type, IntPtr indices);
            internal static DrawElements glDrawElements;
            internal delegate void DrawElementsBaseVertex(Nu.BeginMode mode, Int32 count, Nu.DrawElementsType type, IntPtr indices, Int32 basevertex);
            internal static DrawElementsBaseVertex glDrawElementsBaseVertex;
            internal delegate void DrawElementsIndirect(Nu.BeginMode mode, Nu.DrawElementsType type, IntPtr indirect);
            internal static DrawElementsIndirect glDrawElementsIndirect;
            internal delegate void DrawElementsInstanced(Nu.BeginMode mode, Int32 count, Nu.DrawElementsType type, IntPtr indices, Int32 primcount);
            internal static DrawElementsInstanced glDrawElementsInstanced;
            internal delegate void DrawElementsInstancedBaseInstance(Nu.BeginMode mode, Int32 count, Nu.DrawElementsType type, IntPtr indices, Int32 primcount, UInt32 baseinstance);
            internal static DrawElementsInstancedBaseInstance glDrawElementsInstancedBaseInstance;
            internal delegate void DrawElementsInstancedBaseVertex(Nu.BeginMode mode, Int32 count, Nu.DrawElementsType type, IntPtr indices, Int32 primcount, Int32 basevertex);
            internal static DrawElementsInstancedBaseVertex glDrawElementsInstancedBaseVertex;
            internal delegate void DrawElementsInstancedBaseVertexBaseInstance(Nu.BeginMode mode, Int32 count, Nu.DrawElementsType type, IntPtr indices, Int32 primcount, Int32 basevertex, UInt32 baseinstance);
            internal static DrawElementsInstancedBaseVertexBaseInstance glDrawElementsInstancedBaseVertexBaseInstance;
            internal delegate void DrawRangeElements(Nu.BeginMode mode, UInt32 start, UInt32 end, Int32 count, Nu.DrawElementsType type, IntPtr indices);
            internal static DrawRangeElements glDrawRangeElements;
            internal delegate void DrawRangeElementsBaseVertex(Nu.BeginMode mode, UInt32 start, UInt32 end, Int32 count, Nu.DrawElementsType type, IntPtr indices, Int32 basevertex);
            internal static DrawRangeElementsBaseVertex glDrawRangeElementsBaseVertex;
            internal delegate void DrawTransformFeedback(Nu.NvTransformFeedback2 mode, UInt32 id);
            internal static DrawTransformFeedback glDrawTransformFeedback;
            internal delegate void DrawTransformFeedbackInstanced(Nu.BeginMode mode, UInt32 id, Int32 primcount);
            internal static DrawTransformFeedbackInstanced glDrawTransformFeedbackInstanced;
            internal delegate void DrawTransformFeedbackStream(Nu.NvTransformFeedback2 mode, UInt32 id, UInt32 stream);
            internal static DrawTransformFeedbackStream glDrawTransformFeedbackStream;
            internal delegate void DrawTransformFeedbackStreamInstanced(Nu.BeginMode mode, UInt32 id, UInt32 stream, Int32 primcount);
            internal static DrawTransformFeedbackStreamInstanced glDrawTransformFeedbackStreamInstanced;
            internal delegate void Enable(Nu.EnableCap cap);
            internal static Enable glEnable;
            internal delegate void Disable(Nu.EnableCap cap);
            internal static Disable glDisable;
            internal delegate void Enablei(Nu.EnableCap cap, UInt32 index);
            internal static Enablei glEnablei;
            internal delegate void Disablei(Nu.EnableCap cap, UInt32 index);
            ...
            internal delegate IntPtr FenceSync(Nu.ArbSync condition, UInt32 flags);
            internal static FenceSync glFenceSync;
            internal delegate void Finish();
            internal static Finish glFinish;
            internal delegate void Flush();
            internal static Flush glFlush;
            internal delegate void FlushMappedBufferRange(Nu.BufferTarget target, IntPtr offset, IntPtr length);
            ...
            internal delegate void FramebufferParameteri(Nu.FramebufferTarget target, Nu.FramebufferPName pname, Int32 param);
            internal static FramebufferParameteri glFramebufferParameteri;
            internal delegate void NamedFramebufferParameteri(UInt32 framebuffer, Nu.FramebufferPName pname, Int32 param);
            internal static NamedFramebufferParameteri glNamedFramebufferParameteri;
            internal delegate void FramebufferRenderbuffer(Nu.FramebufferTarget target, Nu.FramebufferAttachment attachment, Nu.RenderbufferTarget renderbuffertarget, UInt32 renderbuffer);
            internal static FramebufferRenderbuffer glFramebufferRenderbuffer;
            internal delegate void NamedFramebufferRenderbuffer(UInt32 framebuffer, Nu.FramebufferAttachment attachment, Nu.RenderbufferTarget renderbuffertarget, UInt32 renderbuffer);
            internal static NamedFramebufferRenderbuffer glNamedFramebufferRenderbuffer;
            internal delegate void FramebufferTexture(Nu.FramebufferTarget target, Nu.FramebufferAttachment attachment, UInt32 texture, Int32 level);
            internal static FramebufferTexture glFramebufferTexture;
            internal delegate void FramebufferTexture1D(Nu.FramebufferTarget target, Nu.FramebufferAttachment attachment, Nu.TextureTarget textarget, UInt32 texture, Int32 level);
            internal static FramebufferTexture1D glFramebufferTexture1D;
            internal delegate void FramebufferTexture2D(Nu.FramebufferTarget target, Nu.FramebufferAttachment attachment, Nu.TextureTarget textarget, UInt32 texture, Int32 level);
            internal static FramebufferTexture2D glFramebufferTexture2D;
            internal delegate void FramebufferTexture3D(Nu.FramebufferTarget target, Nu.FramebufferAttachment attachment, Nu.TextureTarget textarget, UInt32 texture, Int32 level, Int32 layer);
            internal static FramebufferTexture3D glFramebufferTexture3D;
            internal delegate void NamedFramebufferTexture(UInt32 framebuffer, Nu.FramebufferAttachment attachment, UInt32 texture, Int32 level);
            internal static NamedFramebufferTexture glNamedFramebufferTexture;
            internal delegate void FramebufferTextureLayer(Nu.FramebufferTarget target, Nu.FramebufferAttachment attachment, UInt32 texture, Int32 level, Int32 layer);
            internal static FramebufferTextureLayer glFramebufferTextureLayer;
            internal delegate void NamedFramebufferTextureLayer(UInt32 framebuffer, Nu.FramebufferAttachment attachment, UInt32 texture, Int32 level, Int32 layer);
            internal static NamedFramebufferTextureLayer glNamedFramebufferTextureLayer;
            internal delegate void FrontFace(Nu.FrontFaceDirection mode);
            ...
            internal delegate void GenerateMipmap(Nu.GenerateMipmapTarget target);
            ...
            internal delegate void GetBooleanv(Nu.GetPName pname, [OutAttribute] Boolean[] data);
            internal static GetBooleanv glGetBooleanv;
            internal delegate void GetDoublev(Nu.GetPName pname, [OutAttribute] Double[] data);
            internal static GetDoublev glGetDoublev;
            internal delegate void GetFloatv(Nu.GetPName pname, [OutAttribute] Single[] data);
            internal static GetFloatv glGetFloatv;
            internal delegate void GetIntegerv(Nu.GetPName pname, [OutAttribute] Int32[] data);
            internal static GetIntegerv glGetIntegerv;
            internal delegate void GetInteger64v(Nu.ArbSync pname, [OutAttribute] Int64[] data);
            internal static GetInteger64v glGetInteger64v;
            internal delegate void GetBooleani_v(Nu.GetPName target, UInt32 index, [OutAttribute] Boolean[] data);
            internal static GetBooleani_v glGetBooleani_v;
            internal delegate void GetIntegeri_v(Nu.GetPName target, UInt32 index, [OutAttribute] Int32[] data);
            internal static GetIntegeri_v glGetIntegeri_v;
            internal delegate void GetFloati_v(Nu.GetPName target, UInt32 index, [OutAttribute] Single[] data);
            internal static GetFloati_v glGetFloati_v;
            internal delegate void GetDoublei_v(Nu.GetPName target, UInt32 index, [OutAttribute] Double[] data);
            internal static GetDoublei_v glGetDoublei_v;
            internal delegate void GetInteger64i_v(Nu.GetPName target, UInt32 index, [OutAttribute] Int64[] data);
            internal static GetInteger64i_v glGetInteger64i_v;
            internal delegate void GetActiveAtomicCounterBufferiv(UInt32 program, UInt32 bufferIndex, Nu.AtomicCounterParameterName pname, [OutAttribute] Int32[] @params);
            internal static GetActiveAtomicCounterBufferiv glGetActiveAtomicCounterBufferiv;
            internal delegate void GetActiveAttrib(UInt32 program, UInt32 index, Int32 bufSize, [OutAttribute] Int32[] length, [OutAttribute] Int32[] size, [OutAttribute] Nu.ActiveAttribType[] type, [OutAttribute] System.Text.StringBuilder name);
            internal static GetActiveAttrib glGetActiveAttrib;
            internal delegate void GetActiveSubroutineName(UInt32 program, Nu.ShaderType shadertype, UInt32 index, Int32 bufsize, [OutAttribute] Int32[] length, [OutAttribute] System.Text.StringBuilder name);
            internal static GetActiveSubroutineName glGetActiveSubroutineName;
            internal delegate void GetActiveSubroutineUniformiv(UInt32 program, Nu.ShaderType shadertype, UInt32 index, Nu.SubroutineParameterName pname, [OutAttribute] Int32[] values);
            internal static GetActiveSubroutineUniformiv glGetActiveSubroutineUniformiv;
            internal delegate void GetActiveSubroutineUniformName(UInt32 program, Nu.ShaderType shadertype, UInt32 index, Int32 bufsize, [OutAttribute] Int32[] length, [OutAttribute] System.Text.StringBuilder name);
            internal static GetActiveSubroutineUniformName glGetActiveSubroutineUniformName;
            internal delegate void GetActiveUniform(UInt32 program, UInt32 index, Int32 bufSize, [OutAttribute] Int32[] length, [OutAttribute] Int32[] size, [OutAttribute] Nu.ActiveUniformType[] type, [OutAttribute] System.Text.StringBuilder name);
            internal static GetActiveUniform glGetActiveUniform;
            internal delegate void GetActiveUniformBlockiv(UInt32 program, UInt32 uniformBlockIndex, Nu.ActiveUniformBlockParameter pname, [OutAttribute] Int32[] @params);
            ...
            internal delegate void GetActiveUniformsiv(UInt32 program, Int32 uniformCount, [OutAttribute] UInt32[] uniformIndices, Nu.ActiveUniformType pname, [OutAttribute] Int32[] @params);
            ...
            internal delegate void GetBufferParameteriv(Nu.BufferTarget target, Nu.BufferParameterName value, [OutAttribute] Int32[] data);
            internal static GetBufferParameteriv glGetBufferParameteriv;
            internal delegate void GetBufferParameteri64v(Nu.BufferTarget target, Nu.BufferParameterName value, [OutAttribute] Int64[] data);
            internal static GetBufferParameteri64v glGetBufferParameteri64v;
            internal delegate void GetNamedBufferParameteriv(UInt32 buffer, Nu.BufferParameterName pname, [OutAttribute] Int32[] @params);
            internal static GetNamedBufferParameteriv glGetNamedBufferParameteriv;
            internal delegate void GetNamedBufferParameteri64v(UInt32 buffer, Nu.BufferParameterName pname, [OutAttribute] Int64[] @params);
            internal static GetNamedBufferParameteri64v glGetNamedBufferParameteri64v;
            internal delegate void GetBufferPointerv(Nu.BufferTarget target, Nu.BufferPointer pname, [OutAttribute] IntPtr @params);
            internal static GetBufferPointerv glGetBufferPointerv;
            internal delegate void GetNamedBufferPointerv(UInt32 buffer, Nu.BufferPointer pname, [OutAttribute] IntPtr @params);
            internal static GetNamedBufferPointerv glGetNamedBufferPointerv;
            internal delegate void GetBufferSubData(Nu.BufferTarget target, IntPtr offset, IntPtr size, [OutAttribute] IntPtr data);
            ...
            internal delegate void GetCompressedTexImage(Nu.TextureTarget target, Int32 level, [OutAttribute] IntPtr pixels);
            internal static GetCompressedTexImage glGetCompressedTexImage;
            internal delegate void GetnCompressedTexImage(Nu.TextureTarget target, Int32 level, Int32 bufSize, [OutAttribute] IntPtr pixels);
            ...
            internal delegate Nu.ErrorCode GetError();
            ...
            internal delegate void GetFramebufferAttachmentParameteriv(Nu.FramebufferTarget target, Nu.FramebufferAttachment attachment, Nu.FramebufferParameterName pname, [OutAttribute] Int32[] @params);
            internal static GetFramebufferAttachmentParameteriv glGetFramebufferAttachmentParameteriv;
            internal delegate void GetNamedFramebufferAttachmentParameteriv(UInt32 framebuffer, Nu.FramebufferAttachment attachment, Nu.FramebufferParameterName pname, [OutAttribute] Int32[] @params);
            internal static GetNamedFramebufferAttachmentParameteriv glGetNamedFramebufferAttachmentParameteriv;
            internal delegate void GetFramebufferParameteriv(Nu.FramebufferTarget target, Nu.FramebufferPName pname, [OutAttribute] Int32[] @params);
            internal static GetFramebufferParameteriv glGetFramebufferParameteriv;
            internal delegate void GetNamedFramebufferParameteriv(UInt32 framebuffer, Nu.FramebufferPName pname, [OutAttribute] Int32[] param);
            internal static GetNamedFramebufferParameteriv glGetNamedFramebufferParameteriv;
            internal delegate Nu.GraphicResetStatus GetGraphicsResetStatus();
            internal static GetGraphicsResetStatus glGetGraphicsResetStatus;
            internal delegate void GetInternalformativ(Nu.TextureTarget target, Nu.PixelInternalFormat internalFormat, Nu.GetPName pname, Int32 bufSize, [OutAttribute] Int32[] @params);
            internal static GetInternalformativ glGetInternalformativ;
            internal delegate void GetInternalformati64v(Nu.TextureTarget target, Nu.PixelInternalFormat internalFormat, Nu.GetPName pname, Int32 bufSize, [OutAttribute] Int64[] @params);
            internal static GetInternalformati64v glGetInternalformati64v;
            internal delegate void GetMultisamplefv(Nu.GetMultisamplePName pname, UInt32 index, [OutAttribute] Single[] val);
            internal static GetMultisamplefv glGetMultisamplefv;
            internal delegate void GetObjectLabel(Nu.ObjectLabel identifier, UInt32 name, Int32 bufSize, [OutAttribute] Int32[] length, [OutAttribute] System.Text.StringBuilder label);
            ...
            internal delegate void GetPointerv(Nu.GetPointerParameter pname, [OutAttribute] IntPtr @params);
            internal static GetPointerv glGetPointerv;
            internal delegate void GetProgramiv(UInt32 program, Nu.ProgramParameter pname, [OutAttribute] Int32[] @params);
            ...
            internal delegate void GetProgramInterfaceiv(UInt32 program, Nu.ProgramInterface programInterface, Nu.ProgramInterfaceParameterName pname, [OutAttribute] Int32[] @params);
            ...
            internal delegate void GetProgramResourceiv(UInt32 program, Nu.ProgramInterface programInterface, UInt32 index, Int32 propCount, [OutAttribute] Nu.ProgramResourceParameterName[] props, Int32 bufSize, [OutAttribute] Int32[] length, [OutAttribute] Int32[] @params);
            internal static GetProgramResourceiv glGetProgramResourceiv;
            internal delegate UInt32 GetProgramResourceIndex(UInt32 program, Nu.ProgramInterface programInterface, String name);
            internal static GetProgramResourceIndex glGetProgramResourceIndex;
            internal delegate Int32 GetProgramResourceLocation(UInt32 program, Nu.ProgramInterface programInterface, String name);
            internal static GetProgramResourceLocation glGetProgramResourceLocation;
            internal delegate Int32 GetProgramResourceLocationIndex(UInt32 program, Nu.ProgramInterface programInterface, String name);
            internal static GetProgramResourceLocationIndex glGetProgramResourceLocationIndex;
            internal delegate void GetProgramResourceName(UInt32 program, Nu.ProgramInterface programInterface, UInt32 index, Int32 bufSize, [OutAttribute] Int32[] length, [OutAttribute] System.Text.StringBuilder name);
            internal static GetProgramResourceName glGetProgramResourceName;
            internal delegate void GetProgramStageiv(UInt32 program, Nu.ShaderType shadertype, Nu.ProgramStageParameterName pname, [OutAttribute] Int32[] values);
            internal static GetProgramStageiv glGetProgramStageiv;
            internal delegate void GetQueryIndexediv(Nu.QueryTarget target, UInt32 index, Nu.GetQueryParam pname, [OutAttribute] Int32[] @params);
            internal static GetQueryIndexediv glGetQueryIndexediv;
            internal delegate void GetQueryiv(Nu.QueryTarget target, Nu.GetQueryParam pname, [OutAttribute] Int32[] @params);
            internal static GetQueryiv glGetQueryiv;
            internal delegate void GetQueryObjectiv(UInt32 id, Nu.GetQueryObjectParam pname, [OutAttribute] Int32[] @params);
            internal static GetQueryObjectiv glGetQueryObjectiv;
            internal delegate void GetQueryObjectuiv(UInt32 id, Nu.GetQueryObjectParam pname, [OutAttribute] UInt32[] @params);
            internal static GetQueryObjectuiv glGetQueryObjectuiv;
            internal delegate void GetQueryObjecti64v(UInt32 id, Nu.GetQueryObjectParam pname, [OutAttribute] Int64[] @params);
            internal static GetQueryObjecti64v glGetQueryObjecti64v;
            internal delegate void GetQueryObjectui64v(UInt32 id, Nu.GetQueryObjectParam pname, [OutAttribute] UInt64[] @params);
            internal static GetQueryObjectui64v glGetQueryObjectui64v;
            internal delegate void GetRenderbufferParameteriv(Nu.RenderbufferTarget target, Nu.RenderbufferParameterName pname, [OutAttribute] Int32[] @params);
            internal static GetRenderbufferParameteriv glGetRenderbufferParameteriv;
            internal delegate void GetNamedRenderbufferParameteriv(UInt32 renderbuffer, Nu.RenderbufferParameterName pname, [OutAttribute] Int32[] @params);
            internal static GetNamedRenderbufferParameteriv glGetNamedRenderbufferParameteriv;
            internal delegate void GetSamplerParameterfv(UInt32 sampler, Nu.TextureParameterName pname, [OutAttribute] Single[] @params);
            internal static GetSamplerParameterfv glGetSamplerParameterfv;
            internal delegate void GetSamplerParameteriv(UInt32 sampler, Nu.TextureParameterName pname, [OutAttribute] Int32[] @params);
            internal static GetSamplerParameteriv glGetSamplerParameteriv;
            internal delegate void GetSamplerParameterIiv(UInt32 sampler, Nu.TextureParameterName pname, [OutAttribute] Int32[] @params);
            internal static GetSamplerParameterIiv glGetSamplerParameterIiv;
            internal delegate void GetSamplerParameterIuiv(UInt32 sampler, Nu.TextureParameterName pname, [OutAttribute] UInt32[] @params);
            internal static GetSamplerParameterIuiv glGetSamplerParameterIuiv;
            internal delegate void GetShaderiv(UInt32 shader, Nu.ShaderParameter pname, [OutAttribute] Int32[] @params);
            ...
            internal delegate void GetShaderPrecisionFormat(Nu.ShaderType shaderType, Int32 precisionType, [OutAttribute] Int32[] range, [OutAttribute] Int32[] precision);
            ...
            internal delegate IntPtr GetString(Nu.StringName name);
            internal static GetString glGetString;
            internal delegate IntPtr GetStringi(Nu.StringName name, UInt32 index);
            internal static GetStringi glGetStringi;
            internal delegate UInt32 GetSubroutineIndex(UInt32 program, Nu.ShaderType shadertype, String name);
            internal static GetSubroutineIndex glGetSubroutineIndex;
            internal delegate Int32 GetSubroutineUniformLocation(UInt32 program, Nu.ShaderType shadertype, String name);
            internal static GetSubroutineUniformLocation glGetSubroutineUniformLocation;
            internal delegate void GetSynciv(IntPtr sync, Nu.ArbSync pname, Int32 bufSize, [OutAttribute] Int32[] length, [OutAttribute] Int32[] values);
            internal static GetSynciv glGetSynciv;
            internal delegate void GetTexImage(Nu.TextureTarget target, Int32 level, Nu.PixelFormat format, Nu.PixelType type, [OutAttribute] IntPtr pixels);
            internal static GetTexImage glGetTexImage;
            internal delegate void GetnTexImage(Nu.TextureTarget target, Int32 level, Nu.PixelFormat format, Nu.PixelType type, Int32 bufSize, [OutAttribute] IntPtr pixels);
            internal static GetnTexImage glGetnTexImage;
            internal delegate void GetTextureImage(UInt32 texture, Int32 level, Nu.PixelFormat format, Nu.PixelType type, Int32 bufSize, [OutAttribute] IntPtr pixels);
            internal static GetTextureImage glGetTextureImage;
            internal delegate void GetTexLevelParameterfv(Nu.GetPName target, Int32 level, Nu.GetTextureLevelParameter pname, [OutAttribute] Single[] @params);
            internal static GetTexLevelParameterfv glGetTexLevelParameterfv;
            internal delegate void GetTexLevelParameteriv(Nu.GetPName target, Int32 level, Nu.GetTextureLevelParameter pname, [OutAttribute] Int32[] @params);
            internal static GetTexLevelParameteriv glGetTexLevelParameteriv;
            internal delegate void GetTextureLevelParameterfv(UInt32 texture, Int32 level, Nu.GetTextureLevelParameter pname, [OutAttribute] Single[] @params);
            internal static GetTextureLevelParameterfv glGetTextureLevelParameterfv;
            internal delegate void GetTextureLevelParameteriv(UInt32 texture, Int32 level, Nu.GetTextureLevelParameter pname, [OutAttribute] Int32[] @params);
            internal static GetTextureLevelParameteriv glGetTextureLevelParameteriv;
            internal delegate void GetTexParameterfv(Nu.TextureTarget target, Nu.GetTextureParameter pname, [OutAttribute] Single[] @params);
            internal static GetTexParameterfv glGetTexParameterfv;
            internal delegate void GetTexParameteriv(Nu.TextureTarget target, Nu.GetTextureParameter pname, [OutAttribute] Int32[] @params);
            internal static GetTexParameteriv glGetTexParameteriv;
            internal delegate void GetTexParameterIiv(Nu.TextureTarget target, Nu.GetTextureParameter pname, [OutAttribute] Int32[] @params);
            internal static GetTexParameterIiv glGetTexParameterIiv;
            internal delegate void GetTexParameterIuiv(Nu.TextureTarget target, Nu.GetTextureParameter pname, [OutAttribute] UInt32[] @params);
            internal static GetTexParameterIuiv glGetTexParameterIuiv;
            internal delegate void GetTextureParameterfv(UInt32 texture, Nu.GetTextureParameter pname, [OutAttribute] Single[] @params);
            internal static GetTextureParameterfv glGetTextureParameterfv;
            internal delegate void GetTextureParameteriv(UInt32 texture, Nu.GetTextureParameter pname, [OutAttribute] Int32[] @params);
            internal static GetTextureParameteriv glGetTextureParameteriv;
            internal delegate void GetTextureParameterIiv(UInt32 texture, Nu.GetTextureParameter pname, [OutAttribute] Int32[] @params);
            internal static GetTextureParameterIiv glGetTextureParameterIiv;
            internal delegate void GetTextureParameterIuiv(UInt32 texture, Nu.GetTextureParameter pname, [OutAttribute] UInt32[] @params);
            internal static GetTextureParameterIuiv glGetTextureParameterIuiv;
            internal delegate void GetTextureSubImage(UInt32 texture, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, Nu.PixelFormat format, Nu.PixelType type, Int32 bufSize, [OutAttribute] IntPtr pixels);
            internal static GetTextureSubImage glGetTextureSubImage;
            internal delegate void GetTransformFeedbackiv(UInt32 xfb, Nu.TransformFeedbackParameterName pname, [OutAttribute] Int32[] param);
            internal static GetTransformFeedbackiv glGetTransformFeedbackiv;
            internal delegate void GetTransformFeedbacki_v(UInt32 xfb, Nu.TransformFeedbackParameterName pname, UInt32 index, [OutAttribute] Int32[] param);
            internal static GetTransformFeedbacki_v glGetTransformFeedbacki_v;
            internal delegate void GetTransformFeedbacki64_v(UInt32 xfb, Nu.TransformFeedbackParameterName pname, UInt32 index, [OutAttribute] Int64[] param);
            internal static GetTransformFeedbacki64_v glGetTransformFeedbacki64_v;
            internal delegate void GetTransformFeedbackVarying(UInt32 program, UInt32 index, Int32 bufSize, [OutAttribute] Int32[] length, [OutAttribute] Int32[] size, [OutAttribute] Nu.ActiveAttribType[] type, [OutAttribute] System.Text.StringBuilder name);
            ...
            internal delegate void GetUniformSubroutineuiv(Nu.ShaderType shadertype, Int32 location, [OutAttribute] UInt32[] values);
            internal static GetUniformSubroutineuiv glGetUniformSubroutineuiv;
            internal delegate void GetVertexArrayIndexed64iv(UInt32 vaobj, UInt32 index, Nu.VertexAttribParameter pname, [OutAttribute] Int64[] param);
            internal static GetVertexArrayIndexed64iv glGetVertexArrayIndexed64iv;
            internal delegate void GetVertexArrayIndexediv(UInt32 vaobj, UInt32 index, Nu.VertexAttribParameter pname, [OutAttribute] Int32[] param);
            internal static GetVertexArrayIndexediv glGetVertexArrayIndexediv;
            internal delegate void GetVertexArrayiv(UInt32 vaobj, Nu.VertexAttribParameter pname, [OutAttribute] Int32[] param);
            internal static GetVertexArrayiv glGetVertexArrayiv;
            internal delegate void GetVertexAttribdv(UInt32 index, Nu.VertexAttribParameter pname, [OutAttribute] Double[] @params);
            internal static GetVertexAttribdv glGetVertexAttribdv;
            internal delegate void GetVertexAttribfv(UInt32 index, Nu.VertexAttribParameter pname, [OutAttribute] Single[] @params);
            internal static GetVertexAttribfv glGetVertexAttribfv;
            internal delegate void GetVertexAttribiv(UInt32 index, Nu.VertexAttribParameter pname, [OutAttribute] Int32[] @params);
            internal static GetVertexAttribiv glGetVertexAttribiv;
            internal delegate void GetVertexAttribIiv(UInt32 index, Nu.VertexAttribParameter pname, [OutAttribute] Int32[] @params);
            internal static GetVertexAttribIiv glGetVertexAttribIiv;
            internal delegate void GetVertexAttribIuiv(UInt32 index, Nu.VertexAttribParameter pname, [OutAttribute] UInt32[] @params);
            internal static GetVertexAttribIuiv glGetVertexAttribIuiv;
            internal delegate void GetVertexAttribLdv(UInt32 index, Nu.VertexAttribParameter pname, [OutAttribute] Double[] @params);
            internal static GetVertexAttribLdv glGetVertexAttribLdv;
            internal delegate void GetVertexAttribPointerv(UInt32 index, Nu.VertexAttribPointerParameter pname, [OutAttribute] IntPtr pointer);
            internal static GetVertexAttribPointerv glGetVertexAttribPointerv;
            internal delegate void Hint(Nu.HintTarget target, Nu.HintMode mode);
            ...
            internal delegate void InvalidateFramebuffer(Nu.FramebufferTarget target, Int32 numAttachments, Nu.FramebufferAttachment[] attachments);
            internal static InvalidateFramebuffer glInvalidateFramebuffer;
            internal delegate void InvalidateNamedFramebufferData(UInt32 framebuffer, Int32 numAttachments, Nu.FramebufferAttachment[] attachments);
            internal static InvalidateNamedFramebufferData glInvalidateNamedFramebufferData;
            internal delegate void InvalidateSubFramebuffer(Nu.FramebufferTarget target, Int32 numAttachments, Nu.FramebufferAttachment[] attachments, Int32 x, Int32 y, Int32 width, Int32 height);
            internal static InvalidateSubFramebuffer glInvalidateSubFramebuffer;
            internal delegate void InvalidateNamedFramebufferSubData(UInt32 framebuffer, Int32 numAttachments, Nu.FramebufferAttachment[] attachments, Int32 x, Int32 y, Int32 width, Int32 height);
            ...
            internal delegate Boolean IsEnabled(Nu.EnableCap cap);
            internal static IsEnabled glIsEnabled;
            internal delegate Boolean IsEnabledi(Nu.EnableCap cap, UInt32 index);
            ...
            internal delegate void LogicOp(Nu.LogicOp opcode);
            internal static LogicOp glLogicOp;
            internal delegate IntPtr MapBuffer(Nu.BufferTarget target, Nu.BufferAccess access);
            internal static MapBuffer glMapBuffer;
            internal delegate IntPtr MapNamedBuffer(UInt32 buffer, Nu.BufferAccess access);
            internal static MapNamedBuffer glMapNamedBuffer;
            internal delegate IntPtr MapBufferRange(Nu.BufferTarget target, IntPtr offset, IntPtr length, Nu.BufferAccessMask access);
            ...
            internal delegate void MultiDrawArrays(Nu.BeginMode mode, Int32[] first, Int32[] count, Int32 drawcount);
            internal static MultiDrawArrays glMultiDrawArrays;
            internal delegate void MultiDrawArraysIndirect(Nu.BeginMode mode, IntPtr indirect, Int32 drawcount, Int32 stride);
            internal static MultiDrawArraysIndirect glMultiDrawArraysIndirect;
            internal delegate void MultiDrawElements(Nu.BeginMode mode, Int32[] count, Nu.DrawElementsType type, IntPtr indices, Int32 drawcount);
            internal static MultiDrawElements glMultiDrawElements;
            internal delegate void MultiDrawElementsBaseVertex(Nu.BeginMode mode, Int32[] count, Nu.DrawElementsType type, IntPtr indices, Int32 drawcount, Int32[] basevertex);
            internal static MultiDrawElementsBaseVertex glMultiDrawElementsBaseVertex;
            internal delegate void MultiDrawElementsIndirect(Nu.BeginMode mode, Nu.DrawElementsType type, IntPtr indirect, Int32 drawcount, Int32 stride);
            internal static MultiDrawElementsIndirect glMultiDrawElementsIndirect;
            internal delegate void ObjectLabel(Nu.ObjectLabel identifier, UInt32 name, Int32 length, String label);
            ...
            internal delegate void PixelStoref(Nu.PixelStoreParameter pname, Single param);
            internal static PixelStoref glPixelStoref;
            internal delegate void PixelStorei(Nu.PixelStoreParameter pname, Int32 param);
            internal static PixelStorei glPixelStorei;
            internal delegate void PointParameterf(Nu.PointParameterName pname, Single param);
            internal static PointParameterf glPointParameterf;
            internal delegate void PointParameteri(Nu.PointParameterName pname, Int32 param);
            internal static PointParameteri glPointParameteri;
            internal delegate void PointParameterfv(Nu.PointParameterName pname, Single[] @params);
            internal static PointParameterfv glPointParameterfv;
            internal delegate void PointParameteriv(Nu.PointParameterName pname, Int32[] @params);
            ...
            internal delegate void PolygonMode(Nu.MaterialFace face, Nu.PolygonMode mode);
            ...
            internal delegate void ProgramParameteri(UInt32 program, Nu.Version32 pname, Int32 value);
            ...
            internal delegate void ProvokingVertex(Nu.ProvokingVertexMode provokeMode);
            internal static ProvokingVertex glProvokingVertex;
            internal delegate void QueryCounter(UInt32 id, Nu.QueryTarget target);
            internal static QueryCounter glQueryCounter;
            internal delegate void ReadBuffer(Nu.ReadBufferMode mode);
            internal static ReadBuffer glReadBuffer;
            internal delegate void NamedFramebufferReadBuffer(Nu.ReadBufferMode framebuffer, Nu.BeginMode mode);
            internal static NamedFramebufferReadBuffer glNamedFramebufferReadBuffer;
            internal delegate void ReadPixels(Int32 x, Int32 y, Int32 width, Int32 height, Nu.PixelFormat format, Nu.PixelType type, Int32[] data);
            internal static ReadPixels glReadPixels;
            internal delegate void ReadnPixels(Int32 x, Int32 y, Int32 width, Int32 height, Nu.PixelFormat format, Nu.PixelType type, Int32 bufSize, Int32[] data);
            internal static ReadnPixels glReadnPixels;
            internal delegate void RenderbufferStorage(Nu.RenderbufferTarget target, Nu.RenderbufferStorage internalFormat, Int32 width, Int32 height);
            internal static RenderbufferStorage glRenderbufferStorage;
            internal delegate void NamedRenderbufferStorage(UInt32 renderbuffer, Nu.RenderbufferStorage internalFormat, Int32 width, Int32 height);
            internal static NamedRenderbufferStorage glNamedRenderbufferStorage;
            internal delegate void RenderbufferStorageMultisample(Nu.RenderbufferTarget target, Int32 samples, Nu.RenderbufferStorage internalFormat, Int32 width, Int32 height);
            internal static RenderbufferStorageMultisample glRenderbufferStorageMultisample;
            internal delegate void NamedRenderbufferStorageMultisample(UInt32 renderbuffer, Int32 samples, Nu.RenderbufferStorage internalFormat, Int32 width, Int32 height);
            ...
            internal delegate void SamplerParameterf(UInt32 sampler, Nu.TextureParameterName pname, Single param);
            internal static SamplerParameterf glSamplerParameterf;
            internal delegate void SamplerParameteri(UInt32 sampler, Nu.TextureParameterName pname, Int32 param);
            internal static SamplerParameteri glSamplerParameteri;
            internal delegate void SamplerParameterfv(UInt32 sampler, Nu.TextureParameterName pname, Single[] @params);
            internal static SamplerParameterfv glSamplerParameterfv;
            internal delegate void SamplerParameteriv(UInt32 sampler, Nu.TextureParameterName pname, Int32[] @params);
            internal static SamplerParameteriv glSamplerParameteriv;
            internal delegate void SamplerParameterIiv(UInt32 sampler, Nu.TextureParameterName pname, Int32[] @params);
            internal static SamplerParameterIiv glSamplerParameterIiv;
            internal delegate void SamplerParameterIuiv(UInt32 sampler, Nu.TextureParameterName pname, UInt32[] @params);
            ...
            internal delegate void StencilFunc(Nu.StencilFunction func, Int32 @ref, UInt32 mask);
            internal static StencilFunc glStencilFunc;
            internal delegate void StencilFuncSeparate(Nu.StencilFace face, Nu.StencilFunction func, Int32 @ref, UInt32 mask);
            ...
            internal delegate void StencilMaskSeparate(Nu.StencilFace face, UInt32 mask);
            internal static StencilMaskSeparate glStencilMaskSeparate;
            internal delegate void StencilOp(Nu.StencilOp sfail, Nu.StencilOp dpfail, Nu.StencilOp dppass);
            internal static StencilOp glStencilOp;
            internal delegate void StencilOpSeparate(Nu.StencilFace face, Nu.StencilOp sfail, Nu.StencilOp dpfail, Nu.StencilOp dppass);
            internal static StencilOpSeparate glStencilOpSeparate;
            internal delegate void TexBuffer(Nu.TextureBufferTarget target, Nu.SizedInternalFormat internalFormat, UInt32 buffer);
            internal static TexBuffer glTexBuffer;
            internal delegate void TextureBuffer(UInt32 texture, Nu.SizedInternalFormat internalFormat, UInt32 buffer);
            internal static TextureBuffer glTextureBuffer;
            internal delegate void TexBufferRange(Nu.BufferTarget target, Nu.SizedInternalFormat internalFormat, UInt32 buffer, IntPtr offset, IntPtr size);
            internal static TexBufferRange glTexBufferRange;
            internal delegate void TextureBufferRange(UInt32 texture, Nu.SizedInternalFormat internalFormat, UInt32 buffer, IntPtr offset, Int32 size);
            internal static TextureBufferRange glTextureBufferRange;
            internal delegate void TexImage1D(Nu.TextureTarget target, Int32 level, Nu.PixelInternalFormat internalFormat, Int32 width, Int32 border, Nu.PixelFormat format, Nu.PixelType type, IntPtr data);
            internal static TexImage1D glTexImage1D;
            internal delegate void TexImage2D(Nu.TextureTarget target, Int32 level, Nu.PixelInternalFormat internalFormat, Int32 width, Int32 height, Int32 border, Nu.PixelFormat format, Nu.PixelType type, IntPtr data);
            internal static TexImage2D glTexImage2D;
            internal delegate void TexImage2DMultisample(Nu.TextureTargetMultisample target, Int32 samples, Nu.PixelInternalFormat internalFormat, Int32 width, Int32 height, Boolean fixedsamplelocations);
            internal static TexImage2DMultisample glTexImage2DMultisample;
            internal delegate void TexImage3D(Nu.TextureTarget target, Int32 level, Nu.PixelInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth, Int32 border, Nu.PixelFormat format, Nu.PixelType type, IntPtr data);
            internal static TexImage3D glTexImage3D;
            internal delegate void TexImage3DMultisample(Nu.TextureTargetMultisample target, Int32 samples, Nu.PixelInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth, Boolean fixedsamplelocations);
            internal static TexImage3DMultisample glTexImage3DMultisample;
            internal delegate void TexParameterf(Nu.TextureTarget target, Nu.TextureParameterName pname, Single param);
            internal static TexParameterf glTexParameterf;
            internal delegate void TexParameteri(Nu.TextureTarget target, Nu.TextureParameterName pname, Int32 param);
            internal static TexParameteri glTexParameteri;
            internal delegate void TextureParameterf(UInt32 texture, Nu.TextureParameter pname, Single param);
            internal static TextureParameterf glTextureParameterf;
            internal delegate void TextureParameteri(UInt32 texture, Nu.TextureParameter pname, Int32 param);
            internal static TextureParameteri glTextureParameteri;
            internal delegate void TexParameterfv(Nu.TextureTarget target, Nu.TextureParameterName pname, Single[] @params);
            internal static TexParameterfv glTexParameterfv;
            internal delegate void TexParameteriv(Nu.TextureTarget target, Nu.TextureParameterName pname, Int32[] @params);
            internal static TexParameteriv glTexParameteriv;
            internal delegate void TexParameterIiv(Nu.TextureTarget target, Nu.TextureParameterName pname, Int32[] @params);
            internal static TexParameterIiv glTexParameterIiv;
            internal delegate void TexParameterIuiv(Nu.TextureTarget target, Nu.TextureParameterName pname, UInt32[] @params);
            internal static TexParameterIuiv glTexParameterIuiv;
            internal delegate void TextureParameterfv(UInt32 texture, Nu.TextureParameter pname, Single[] paramtexture);
            internal static TextureParameterfv glTextureParameterfv;
            internal delegate void TextureParameteriv(UInt32 texture, Nu.TextureParameter pname, Int32[] param);
            internal static TextureParameteriv glTextureParameteriv;
            internal delegate void TextureParameterIiv(UInt32 texture, Nu.TextureParameter pname, Int32[] @params);
            internal static TextureParameterIiv glTextureParameterIiv;
            internal delegate void TextureParameterIuiv(UInt32 texture, Nu.TextureParameter pname, UInt32[] @params);
            internal static TextureParameterIuiv glTextureParameterIuiv;
            internal delegate void TexStorage1D(Nu.TextureTarget target, Int32 levels, Nu.SizedInternalFormat internalFormat, Int32 width);
            internal static TexStorage1D glTexStorage1D;
            internal delegate void TextureStorage1D(UInt32 texture, Int32 levels, Nu.SizedInternalFormat internalFormat, Int32 width);
            internal static TextureStorage1D glTextureStorage1D;
            internal delegate void TexStorage2D(Nu.TextureTarget target, Int32 levels, Nu.SizedInternalFormat internalFormat, Int32 width, Int32 height);
            internal static TexStorage2D glTexStorage2D;
            internal delegate void TextureStorage2D(UInt32 texture, Int32 levels, Nu.SizedInternalFormat internalFormat, Int32 width, Int32 height);
            internal static TextureStorage2D glTextureStorage2D;
            internal delegate void TexStorage2DMultisample(Nu.TextureTarget target, Int32 samples, Nu.SizedInternalFormat internalFormat, Int32 width, Int32 height, Boolean fixedsamplelocations);
            internal static TexStorage2DMultisample glTexStorage2DMultisample;
            internal delegate void TextureStorage2DMultisample(UInt32 texture, Int32 samples, Nu.SizedInternalFormat internalFormat, Int32 width, Int32 height, Boolean fixedsamplelocations);
            internal static TextureStorage2DMultisample glTextureStorage2DMultisample;
            internal delegate void TexStorage3D(Nu.TextureTarget target, Int32 levels, Nu.SizedInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth);
            internal static TexStorage3D glTexStorage3D;
            internal delegate void TextureStorage3D(UInt32 texture, Int32 levels, Nu.SizedInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth);
            internal static TextureStorage3D glTextureStorage3D;
            internal delegate void TexStorage3DMultisample(Nu.TextureTarget target, Int32 samples, Nu.SizedInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth, Boolean fixedsamplelocations);
            internal static TexStorage3DMultisample glTexStorage3DMultisample;
            internal delegate void TextureStorage3DMultisample(UInt32 texture, Int32 samples, Nu.SizedInternalFormat internalFormat, Int32 width, Int32 height, Int32 depth, Boolean fixedsamplelocations);
            internal static TextureStorage3DMultisample glTextureStorage3DMultisample;
            internal delegate void TexSubImage1D(Nu.TextureTarget target, Int32 level, Int32 xoffset, Int32 width, Nu.PixelFormat format, Nu.PixelType type, IntPtr pixels);
            internal static TexSubImage1D glTexSubImage1D;
            internal delegate void TextureSubImage1D(UInt32 texture, Int32 level, Int32 xoffset, Int32 width, Nu.PixelFormat format, Nu.PixelType type, IntPtr pixels);
            internal static TextureSubImage1D glTextureSubImage1D;
            internal delegate void TexSubImage2D(Nu.TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 width, Int32 height, Nu.PixelFormat format, Nu.PixelType type, IntPtr pixels);
            internal static TexSubImage2D glTexSubImage2D;
            internal delegate void TextureSubImage2D(UInt32 texture, Int32 level, Int32 xoffset, Int32 yoffset, Int32 width, Int32 height, Nu.PixelFormat format, Nu.PixelType type, IntPtr pixels);
            internal static TextureSubImage2D glTextureSubImage2D;
            internal delegate void TexSubImage3D(Nu.TextureTarget target, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, Nu.PixelFormat format, Nu.PixelType type, IntPtr pixels);
            internal static TexSubImage3D glTexSubImage3D;
            internal delegate void TextureSubImage3D(UInt32 texture, Int32 level, Int32 xoffset, Int32 yoffset, Int32 zoffset, Int32 width, Int32 height, Int32 depth, Nu.PixelFormat format, Nu.PixelType type, IntPtr pixels);
            ...
            internal delegate void TextureView(UInt32 texture, Nu.TextureTarget target, UInt32 origtexture, Nu.PixelInternalFormat internalFormat, UInt32 minlevel, UInt32 numlevels, UInt32 minlayer, UInt32 numlayers);
            ...
            internal delegate void TransformFeedbackVaryings(UInt32 program, Int32 count, String[] varyings, Nu.TransformFeedbackMode bufferMode);
            ...
            internal delegate void UniformSubroutinesuiv(Nu.ShaderType shadertype, Int32 count, UInt32[] indices);
            internal static UniformSubroutinesuiv glUniformSubroutinesuiv;
            internal delegate Boolean UnmapBuffer(Nu.BufferTarget target);
            ...
            internal delegate void VertexAttribP1ui(UInt32 index, Nu.VertexAttribPType type, Boolean normalized, UInt32 value);
            internal static VertexAttribP1ui glVertexAttribP1ui;
            internal delegate void VertexAttribP2ui(UInt32 index, Nu.VertexAttribPType type, Boolean normalized, UInt32 value);
            internal static VertexAttribP2ui glVertexAttribP2ui;
            internal delegate void VertexAttribP3ui(UInt32 index, Nu.VertexAttribPType type, Boolean normalized, UInt32 value);
            internal static VertexAttribP3ui glVertexAttribP3ui;
            internal delegate void VertexAttribP4ui(UInt32 index, Nu.VertexAttribPType type, Boolean normalized, UInt32 value);
            ...
            internal delegate void VertexAttribFormat(UInt32 attribindex, Int32 size, Nu.VertexAttribFormat type, Boolean normalized, UInt32 relativeoffset);
            internal static VertexAttribFormat glVertexAttribFormat;
            internal delegate void VertexAttribIFormat(UInt32 attribindex, Int32 size, Nu.VertexAttribFormat type, UInt32 relativeoffset);
            internal static VertexAttribIFormat glVertexAttribIFormat;
            internal delegate void VertexAttribLFormat(UInt32 attribindex, Int32 size, Nu.VertexAttribFormat type, UInt32 relativeoffset);
            internal static VertexAttribLFormat glVertexAttribLFormat;
            internal delegate void VertexArrayAttribFormat(UInt32 vaobj, UInt32 attribindex, Int32 size, Nu.VertexAttribFormat type, Boolean normalized, UInt32 relativeoffset);
            internal static VertexArrayAttribFormat glVertexArrayAttribFormat;
            internal delegate void VertexArrayAttribIFormat(UInt32 vaobj, UInt32 attribindex, Int32 size, Nu.VertexAttribFormat type, UInt32 relativeoffset);
            internal static VertexArrayAttribIFormat glVertexArrayAttribIFormat;
            internal delegate void VertexArrayAttribLFormat(UInt32 vaobj, UInt32 attribindex, Int32 size, Nu.VertexAttribFormat type, UInt32 relativeoffset);
            internal static VertexArrayAttribLFormat glVertexArrayAttribLFormat;
            internal delegate void VertexAttribPointer(UInt32 index, Int32 size, Nu.VertexAttribPointerType type, Boolean normalized, Int32 stride, IntPtr pointer);
            internal static VertexAttribPointer glVertexAttribPointer;
            internal delegate void VertexAttribIPointer(UInt32 index, Int32 size, Nu.VertexAttribPointerType type, Int32 stride, IntPtr pointer);
            internal static VertexAttribIPointer glVertexAttribIPointer;
            internal delegate void VertexAttribLPointer(UInt32 index, Int32 size, Nu.VertexAttribPointerType type, Int32 stride, IntPtr pointer);
