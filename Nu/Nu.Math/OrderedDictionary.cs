...
namespace System.Collections.Generic
{
    ...
    public sealed class OrderedDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IList<KeyValuePair<TKey, TValue>>
    {
        ...
        public sealed class KeyCollection : ICollection<TKey>
        {
            ...
            [EditorBrowsable(EditorBrowsableState.Never)]
            void ICollection<TKey>.Add(TKey item) => throw new NotSupportedException(String.Empty);

            [EditorBrowsable(EditorBrowsableState.Never)]
            void ICollection<TKey>.Clear() => throw new NotSupportedException(String.Empty);

            [EditorBrowsable(EditorBrowsableState.Never)]
            bool ICollection<TKey>.IsReadOnly => true;

            [EditorBrowsable(EditorBrowsableState.Never)]
            bool ICollection<TKey>.Remove(TKey item) => throw new NotSupportedException(String.Empty);
        ...
        public sealed class ValueCollection : ICollection<TValue>
        {
            ...
            [EditorBrowsable(EditorBrowsableState.Never)]
            void ICollection<TValue>.Add(TValue item) => throw new NotSupportedException(String.Empty);

            [EditorBrowsable(EditorBrowsableState.Never)]
            void ICollection<TValue>.Clear() => throw new NotSupportedException(String.Empty);

            [EditorBrowsable(EditorBrowsableState.Never)]
            bool ICollection<TValue>.IsReadOnly => true;

            [EditorBrowsable(EditorBrowsableState.Never)]
            bool ICollection<TValue>.Remove(TValue item) => throw new NotSupportedException(String.Empty);
