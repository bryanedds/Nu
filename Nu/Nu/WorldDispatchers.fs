...
module ScriptFacetModule =
    ...
    type Entity with
        ...
        member internal this.GetScriptFrameNp world : Scripting.DeclarationFrame = this.Get Property? ScriptFrameNp world
        member internal this.SetScriptFrameNp (value : Scripting.DeclarationFrame) world = this.Set Property? ScriptFrameNp value world
        member internal this.ScriptFrameNp = PropertyTag.make this Property? ScriptFrameNp this.GetScriptFrameNp this.SetScriptFrameNp
