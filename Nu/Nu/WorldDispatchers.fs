        ...
        override this.Register (entity, world) =
            ...
            List.fold (fun world initializer ->
                ...
                | FixDefinition (lensLeft, lensRight, breaking) ->
                    WorldModule.fix5 entity lensLeft lensRight breaking world)
                world initializers
    ...
    and [<AbstractClass>] LayerDispatcher<'model, 'message, 'command> (initial : 'model) =
        ...
        override this.Register (layer, world) =
            ...
            List.fold (fun world initializer ->
                ...
                | FixDefinition (lensLeft, lensRight, breaking) ->
                    WorldModule.fix5 layer lensLeft lensRight breaking world)
                world initializers
    ...
    and [<AbstractClass>] ScreenDispatcher<'model, 'message, 'command> (initial : 'model) =
        ...
        override this.Register (screen, world) =
            ...
            List.fold (fun world initializer ->
                ...
                | FixDefinition (lensLeft, lensRight, breaking) ->
                    WorldModule.fix5 screen lensLeft lensRight breaking world)
                world initializers
