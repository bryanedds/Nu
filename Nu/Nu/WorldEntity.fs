...
module WorldEntityModule =
    ...
    type Entity with
        ...
        member this.GetSystemNameOpt world = World.getEntitySystemNameOpt this world
        member this.SetSystemNameOpt value world = World.setEntitySystemNameOpt value this world
        member this.SystemNameOpt = lens Property? SystemNameOpt this.GetSystemNameOpt this.SetSystemNameOpt this
