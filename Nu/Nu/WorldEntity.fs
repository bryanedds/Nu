...
module WorldEntityModule =
    ...
    type Entity with
        ...
        member this.SetDimensionsScaled value world = World.setEntityDimensionsScaled value this world |> snd'
        member this.GetDimensionsScaled world = World.getEntityDimensionsScaled this world
        member this.DimensionsScaled = lens Property? DimensionsScaled this.GetDimensionsScaled this.SetDimensionsScaled this
