...
module WorldEntityModule =
    ...
    type Entity with
        ...
        member this.PerimeterCenter = lens Property? PerimeterCenter this.GetPerimeterCenter this.SetPerimeterCenter this
        ...
        member this.PerimeterBottom = lens Property? PerimeterBottom this.GetPerimeterBottom this.SetPerimeterBottom this
        ...
        member this.GetIsPhysical world = World.getEntityIsPhysical this world
        member this.IsPhysical = lensReadOnly Property? IsPhysical this.GetIsPhysical this
        member this.GetIsCartesian world = World.getEntityIsCartesian this world
        member this.IsCartesian = lensReadOnly Property? IsCartesian this.GetIsCartesian this
