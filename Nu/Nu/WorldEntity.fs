...
module WorldEntityModule =
    ...
    type Entity with
        ...
        member this.GetUserValue world = World.getEntityUserValue<'a> this world
        member this.SetUserValue value world = World.setEntityUserValue<'a> value this world
        member this.UserValue = PropertyTag.make this Property? UserValue this.GetUserValue this.SetUserValue
        ...
        member this.OverlayNameOpt = PropertyTag.makeReadOnly this Property? OverlayNameOpt this.GetOverlayNameOpt
        ...
        member this.AlwaysUpdate = PropertyTag.make this Property? AlwaysUpdate this.GetAlwaysUpdate this.SetAlwaysUpdate
