...
module Assets =
    ...
    module Default =
        ...
        let (*Literal*) SkyBoxCubeBack = asset<CubeMap> PackageName Assets.Default.SkyBoxCubeBackName
        let (*Literal*) SkyBoxCubeBottom = asset<CubeMap> PackageName Assets.Default.SkyBoxCubeBottomName
        let (*Literal*) SkyBoxCubeFront = asset<CubeMap> PackageName Assets.Default.SkyBoxCubeFrontName
        let (*Literal*) SkyBoxCubeLeft = asset<CubeMap> PackageName Assets.Default.SkyBoxCubeLeftName
        let (*Literal*) SkyBoxCubeRight = asset<CubeMap> PackageName Assets.Default.SkyBoxCubeRightName
        let (*Literal*) SkyBoxCubeTop = asset<CubeMap> PackageName Assets.Default.SkyBoxCubeTopName
