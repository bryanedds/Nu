...
module Assets =
    ...
    module Default =
        ...
        let (*Literal*) EmptyTileMap = asset<Image> PackageName Assets.Default.EmptyTileMapName
        ...
        let (*Literal*) CharacterIdleImage = asset<Image> PackageName Assets.Default.CharacterIdleImageName
        let (*Literal*) CharacterJumpImage = asset<Image> PackageName Assets.Default.CharacterJumpImageName
        let (*Literal*) CharacterWalkImage = asset<Image> PackageName Assets.Default.CharacterWalkImageName
