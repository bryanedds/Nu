...
type 'w Query
    ...
    member this.Index (compName, statement : Statement<'c, 's>, entityId) : 's -> 's =
        fun state ->
    ...
    member this.Index (compName, comp2Name, statement : Statement<'c, 'c2, 's>, entityId) : 's -> 's =
        fun state ->
            let archetypeSlot = ecs.IndexArchetypeSlot entityId
            let stores = archetypeSlot.Archetype.Stores
            let store = stores.[compName] :?> 'c Store
    ...
    member this.Index (compName, comp2Name, comp3Name, statement : Statement<'c, 'c2, 'c3, 's>, entityId) : 's -> 's =
        fun state ->
            let archetypeSlot = ecs.IndexArchetypeSlot entityId
            let stores = archetypeSlot.Archetype.Stores
            let store = stores.[compName] :?> 'c Store
    ...
    member this.Index (compName, comp2Name, comp3Name, comp4Name, statement : Statement<'c, 'c2, 'c3, 'c4, 's>, entityId) : 's -> 's =
        fun state ->
            let archetypeSlot = ecs.IndexArchetypeSlot entityId
            let stores = archetypeSlot.Archetype.Stores
            let store = stores.[compName] :?> 'c Store
    ...
    member this.Index (compName, comp2Name, comp3Name, comp4Name, comp5Name, statement : Statement<'c, 'c2, 'c3, 'c4, 'c5, 's>, entityId) : 's -> 's =
        fun state ->
            let archetypeSlot = ecs.IndexArchetypeSlot entityId
            let stores = archetypeSlot.Archetype.Stores
            let store = stores.[compName] :?> 'c Store
    ...
    member this.Index (compName, comp2Name, comp3Name, comp4Name, comp5Name, comp6Name, statement : Statement<'c, 'c2, 'c3, 'c4, 'c5, 'c6, 's>, entityId) : 's -> 's =
        fun state ->
            let archetypeSlot = ecs.IndexArchetypeSlot entityId
            let stores = archetypeSlot.Archetype.Stores
            let store = stores.[compName] :?> 'c Store
    ...
    member this.Index (compName, comp2Name, comp3Name, comp4Name, comp5Name, comp6Name, comp7Name, statement : Statement<'c, 'c2, 'c3, 'c4, 'c5, 'c6, 'c7, 's>, entityId) : 's -> 's =
        fun state ->
            let archetypeSlot = ecs.IndexArchetypeSlot entityId
            let stores = archetypeSlot.Archetype.Stores
            let store = stores.[compName] :?> 'c Store
    ...
    member this.Index (compName, comp2Name, comp3Name, comp4Name, comp5Name, comp6Name, comp7Name, comp8Name, statement : Statement<'c, 'c2, 'c3, 'c4, 'c5, 'c6, 'c7, 'c8, 's>, entityId) : 's -> 's =
        fun state ->
            let archetypeSlot = ecs.IndexArchetypeSlot entityId
            let stores = archetypeSlot.Archetype.Stores
            let store = stores.[compName] :?> 'c Store
    ...
    member this.Index (compName, comp2Name, comp3Name, comp4Name, comp5Name, comp6Name, comp7Name, comp8Name, comp9Name, statement : Statement<'c, 'c2, 'c3, 'c4, 'c5, 'c6, 'c7, 'c8, 'c9, 's>, entityId) : 's -> 's =
        fun state ->
            let archetypeSlot = ecs.IndexArchetypeSlot entityId
            let stores = archetypeSlot.Archetype.Stores
            let store = stores.[compName] :?> 'c Store
    ...
    member this.Index<'c, 's when
        'c : struct and 'c :> 'c Component>
        (statement : Statement<'c, 's>, entityId) : 's -> 's =
        this.Index (typeof<'c>.Name, statement, entityId)

    member this.Index<'c, 'c2, 's when
        'c : struct and 'c :> 'c Component and
        'c2 : struct and 'c2 :> 'c2 Component>
        (statement : Statement<'c, 'c2, 's>, entityId) : 's -> 's =
        this.Index (typeof<'c>.Name, typeof<'c2>.Name, statement, entityId)

    member this.Index<'c, 'c2, 'c3, 's when
        'c : struct and 'c :> 'c Component and
        'c2 : struct and 'c2 :> 'c2 Component and
        'c3 : struct and 'c3 :> 'c3 Component>
        (statement : Statement<'c, 'c2, 'c3, 's>, entityId) : 's -> 's =
        this.Index (typeof<'c>.Name, typeof<'c2>.Name, typeof<'c3>.Name, statement, entityId)
    ...
    member this.Index<'c, 'c2, 'c3, 'c4, 's when
        ...
        'c3 : struct and 'c3 :> 'c3 Component and
        'c4 : struct and 'c4 :> 'c4 Component>
        (statement : Statement<'c, 'c2, 'c3, 'c4, 's>, entityId) : 's -> 's =
        this.Index (typeof<'c>.Name, typeof<'c2>.Name, typeof<'c3>.Name, typeof<'c4>.Name, statement, entityId)
    ...
    member this.Index<'c, 'c2, 'c3, 'c4, 'c5, 's when
        ...
        'c4 : struct and 'c4 :> 'c4 Component and
        'c5 : struct and 'c5 :> 'c5 Component>
        (statement : Statement<'c, 'c2, 'c3, 'c4, 'c5, 's>, entityId) : 's -> 's =
        this.Index (typeof<'c>.Name, typeof<'c2>.Name, typeof<'c3>.Name, typeof<'c4>.Name, typeof<'c5>.Name, statement, entityId)
    ...
    member this.Index<'c, 'c2, 'c3, 'c4, 'c5, 'c6, 's when
        ...
        'c5 : struct and 'c5 :> 'c5 Component and
        'c6 : struct and 'c6 :> 'c6 Component>
        (statement : Statement<'c, 'c2, 'c3, 'c4, 'c5, 'c6, 's>, entityId) : 's -> 's =
        this.Index (typeof<'c>.Name, typeof<'c2>.Name, typeof<'c3>.Name, typeof<'c4>.Name, typeof<'c5>.Name, typeof<'c6>.Name, statement, entityId)
    ...
    member this.Index<'c, 'c2, 'c3, 'c4, 'c5, 'c6, 'c7, 's when
        ...
        'c6 : struct and 'c6 :> 'c6 Component and
        'c7 : struct and 'c7 :> 'c7 Component>
        (statement : Statement<'c, 'c2, 'c3, 'c4, 'c5, 'c6, 'c7, 's>, entityId) : 's -> 's =
        this.Index (typeof<'c>.Name, typeof<'c2>.Name, typeof<'c3>.Name, typeof<'c4>.Name, typeof<'c5>.Name, typeof<'c6>.Name, typeof<'c7>.Name, statement, entityId)
    ...
    member this.Index<'c, 'c2, 'c3, 'c4, 'c5, 'c6, 'c7, 'c8, 's when
        ...
        'c7 : struct and 'c7 :> 'c7 Component and
        'c8 : struct and 'c8 :> 'c8 Component>
        (statement : Statement<'c, 'c2, 'c3, 'c4, 'c5, 'c6, 'c7, 'c8, 's>, entityId) : 's -> 's =
        this.Index (typeof<'c>.Name, typeof<'c2>.Name, typeof<'c3>.Name, typeof<'c4>.Name, typeof<'c5>.Name, typeof<'c6>.Name, typeof<'c7>.Name, typeof<'c8>.Name, statement, entityId)
    ...
    member this.Index<'c, 'c2, 'c3, 'c4, 'c5, 'c6, 'c7, 'c8, 'c9, 's when
        ...
        'c8 : struct and 'c8 :> 'c8 Component and
        'c9 : struct and 'c9 :> 'c9 Component>
        (statement : Statement<'c, 'c2, 'c3, 'c4, 'c5, 'c6, 'c7, 'c8, 'c9, 's>, entityId) : 's -> 's =
        this.Index (typeof<'c>.Name, typeof<'c2>.Name, typeof<'c3>.Name, typeof<'c4>.Name, typeof<'c5>.Name, typeof<'c6>.Name, typeof<'c7>.Name, typeof<'c8>.Name, typeof<'c9>.Name, statement, entityId)
