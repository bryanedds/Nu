...
module PhysicallyBased =
    ...
    let CreatePhysicallyBasedDeferredLightingShader (shaderFilePath : string) =
        ...
        let lightShadowBiasAcneUniform = Gl.GetUniformLocation (shader, "lightShadowBiasAcne")
        let lightShadowBiasBleedUniform = Gl.GetUniformLocation (shader, "lightShadowBiasBleed")
        let ssrEnabledUniform = Gl.GetUniformLocation (shader, "ssrEnabledUniform")
        let ssrDetailUniform = Gl.GetUniformLocation (shader, "ssrDetailUniform")
        let ssrRefinementsMaxUniform = Gl.GetUniformLocation (shader, "ssrRefinementsMaxUniform")
        let ssrRayThicknessUniform = Gl.GetUniformLocation (shader, "ssrRayThicknessUniform")
        let ssrDepthCutoffUniform = Gl.GetUniformLocation (shader, "ssrDepthCutoffUniform")
        let ssrDepthCutoffMarginUniform = Gl.GetUniformLocation (shader, "ssrDepthCutoffMarginUniform")
        let ssrDistanceCutoffUniform = Gl.GetUniformLocation (shader, "ssrDistanceCutoffUniform")
        let ssrDistanceCutoffMarginUniform = Gl.GetUniformLocation (shader, "ssrDistanceCutoffMarginUniform")
        let ssrRoughnessCutoffUniform = Gl.GetUniformLocation (shader, "ssrRoughnessCutoffUniform")
        let ssrRoughnessCutoffMarginUniform = Gl.GetUniformLocation (shader, "ssrRoughnessCutoffMarginUniform")
        let ssrSlopeCutoffUniform = Gl.GetUniformLocation (shader, "ssrSlopeCutoffUniform")
        let ssrSlopeCutoffMarginUniform = Gl.GetUniformLocation (shader, "ssrSlopeCutoffMarginUniform")
        let ssrEdgeHorizontalMarginUniform = Gl.GetUniformLocation (shader, "ssrEdgeHorizontalMarginUniform")
        let ssrEdgeVerticalMarginUniform = Gl.GetUniformLocation (shader, "ssrEdgeVerticalMarginUniform")
        let ssrLightColorUniform = Gl.GetUniformLocation (shader, "ssrLightColorUniform")
        let ssrLightBrightnessUniform = Gl.GetUniformLocation (shader, "ssrLightBrightnessUniform")
        let positionTextureUniform = Gl.GetUniformLocation (shader, "positionTexture")
        let albedoTextureUniform = Gl.GetUniformLocation (shader, "albedoTexture")
        let materialTextureUniform = Gl.GetUniformLocation (shader, "materialTexture")
        let normalPlusTextureUniform = Gl.GetUniformLocation (shader, "normalPlusTexture")
