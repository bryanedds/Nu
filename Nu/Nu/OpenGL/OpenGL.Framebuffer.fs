...
module Framebuffer =
    ...
    let TryCreateColorBuffers (resolutionX, resolutionY, filtered, depthAndStencil) =
        ...
        // create render buffer with optional depth and stencil buffering
        let renderbuffer = Gl.GenRenderbuffer ()
        Gl.BindRenderbuffer (RenderbufferTarget.Renderbuffer, renderbuffer)
        if depthAndStencil then
            Gl.RenderbufferStorage (RenderbufferTarget.Renderbuffer, Hl.CheckRenderFormat InternalFormat.Depth24Stencil8, resolutionX, resolutionY)
    ...
    let TryCreateFilterBox1dBuffers (resolutionX, resolutionY) =
        ...
        Gl.TexImage2D (TextureTarget.Texture2d, 0, Hl.CheckRenderFormat InternalFormat.R16f, resolutionX, resolutionY, 0, PixelFormat.Red, PixelType.HalfFloat, nativeint 0)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureMinFilter, int TextureMinFilter.Nearest)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureMagFilter, int TextureMagFilter.Nearest)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureWrapS, int TextureWrapMode.ClampToEdge)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureWrapT, int TextureWrapMode.ClampToEdge)
    ...
    let TryCreateFilterGaussian2dBuffers (resolutionX, resolutionY) =
        ...
        Gl.TexImage2D (TextureTarget.Texture2d, 0, Hl.CheckRenderFormat InternalFormat.Rg16f, resolutionX, resolutionY, 0, PixelFormat.Rg, PixelType.HalfFloat, nativeint 0)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureMinFilter, int TextureMinFilter.Nearest)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureMagFilter, int TextureMagFilter.Nearest)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureWrapS, int TextureWrapMode.ClampToEdge)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureWrapT, int TextureWrapMode.ClampToEdge)
    ...
    /// Attempt to create shadow texture array buffers.
    let TryCreateShadowTextureArrayBuffers (shadowResolutionX, shadowResolutionY, shadowResolutionZ) =
        ...
        // create shadow texture array
        let shadowTextureArrayId = Gl.GenTexture ()
        Gl.BindTexture (TextureTarget.Texture2dArray, shadowTextureArrayId)
        Gl.FramebufferTexture (FramebufferTarget.Framebuffer, FramebufferAttachment.ColorAttachment0, shadowTextureArrayId, 0)
        Hl.Assert ()

        // setup shadow texture array texture
        Gl.TexImage3D (TextureTarget.Texture2dArray, 0, Hl.CheckRenderFormat InternalFormat.Rgba32f, shadowResolutionX, shadowResolutionY, shadowResolutionZ, 0, PixelFormat.Rgba, PixelType.Float, nativeint 0)
        ...
        // assert shadow texture array framebuffer completion
        let result =
            Gl.FramebufferTextureLayer (FramebufferTarget.Framebuffer, FramebufferAttachment.ColorAttachment0, shadowTextureArrayId, 0, 0)
            if Gl.CheckFramebufferStatus FramebufferTarget.Framebuffer = FramebufferStatus.FramebufferComplete then
                let shadowTextureArray = Texture.EagerTexture { TextureMetadata = Texture.TextureMetadata.empty; TextureId = shadowTextureArrayId }
                Right (shadowTextureArray, shadowRenderbuffer, shadowFramebuffer)
            else Left "Shadow texture array framebuffer is incomplete!"
    ...
    /// Destroy shadow texture array buffers.
    let DestroyShadowTextureArrayBuffers (shadowTexture : Texture.Texture, renderbuffer, framebuffer) =
        Gl.DeleteRenderbuffers [|renderbuffer|]
        Gl.DeleteFramebuffers [|framebuffer|]
        shadowTexture.Destroy ()

    /// Attempt to create shadow texture filter buffers.
    let TryCreateShadowTextureFilterBuffers (shadowResolutionX, shadowResolutionY) =
        ...
        Gl.TexImage2D (TextureTarget.Texture2d, 0, Hl.CheckRenderFormat InternalFormat.Rgba32f, shadowResolutionX, shadowResolutionY, 0, PixelFormat.Rgba, PixelType.Float, nativeint 0)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureMinFilter, int TextureMinFilter.Linear)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureMagFilter, int TextureMagFilter.Linear)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureWrapS, int TextureWrapMode.ClampToEdge)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureWrapT, int TextureWrapMode.ClampToEdge)
        ...
        else Left "Could not create complete shadow texture filter framebuffer."

    /// Destroy shadow texture filter buffers.
    let DestroyShadowTextureFilterBuffers (shadowTexture : Texture.Texture, renderbuffer, framebuffer) =
        Gl.DeleteRenderbuffers [|renderbuffer|]
        Gl.DeleteFramebuffers [|framebuffer|]
        shadowTexture.Destroy ()
    ...
    let TryCreateShadowMapBuffers (shadowResolutionX, shadowResolutionY) =
        ...
        for i in 0 .. dec 6 do
            ...
            Gl.TexImage2D (target, 0, Hl.CheckRenderFormat InternalFormat.R16f, shadowResolutionX, shadowResolutionY, 0, PixelFormat.Red, PixelType.HalfFloat, nativeint 0)
    ...
    let TryCreateShadowCascadeArrayBuffers (shadowCascadeResolutionX, shadowCascadeResolutionY, shadowCascadeLevels) =

        // create shadow renderbuffer
        let shadowRenderbuffer = Gl.GenRenderbuffer ()
        Gl.BindRenderbuffer (RenderbufferTarget.Renderbuffer, shadowRenderbuffer)
        Gl.RenderbufferStorage (RenderbufferTarget.Renderbuffer, Hl.CheckRenderFormat InternalFormat.DepthComponent32, shadowCascadeResolutionX, shadowCascadeResolutionY)
        Hl.Assert ()
        ...
        Gl.TexImage3D (TextureTarget.Texture2dArray, 0, Hl.CheckRenderFormat InternalFormat.Rg32f, shadowCascadeResolutionX, shadowCascadeResolutionY, shadowCascadeLevels, 0, PixelFormat.Rg, PixelType.Float, nativeint 0)
        Gl.TexParameter (TextureTarget.Texture2dArray, TextureParameterName.TextureMinFilter, int TextureMinFilter.Linear)
        Gl.TexParameter (TextureTarget.Texture2dArray, TextureParameterName.TextureMagFilter, int TextureMagFilter.Linear)
        Gl.TexParameter (TextureTarget.Texture2dArray, TextureParameterName.TextureWrapS, int TextureWrapMode.ClampToEdge)
        Gl.TexParameter (TextureTarget.Texture2dArray, TextureParameterName.TextureWrapT, int TextureWrapMode.ClampToEdge)
        ...
        let result =
            ...
            if Gl.CheckFramebufferStatus FramebufferTarget.Framebuffer = FramebufferStatus.FramebufferComplete then
                let shadowCascadeArray = Texture.EagerTexture { TextureMetadata = Texture.TextureMetadata.empty; TextureId = shadowCascadeArrayId }
                Right (shadowCascadeArray, shadowRenderbuffer, shadowFramebuffer)
    ...
    let DestroyShadowCascadeArrayBuffers (shadowCascadeArray : Texture.Texture, renderbuffer, framebuffer) =
        Gl.DeleteRenderbuffers [|renderbuffer|]
        Gl.DeleteFramebuffers [|framebuffer|]
        shadowCascadeArray.Destroy ()
    ...
    let TryCreateGeometryBuffers (resolutionX, resolutionY) =
        ...
        Gl.TexImage2D (TextureTarget.Texture2d, 0, Hl.CheckRenderFormat InternalFormat.R32f, resolutionX, resolutionY, 0, PixelFormat.Red, PixelType.Float, nativeint 0)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureMinFilter, int TextureMinFilter.Nearest)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureMagFilter, int TextureMagFilter.Nearest)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureWrapS, int TextureWrapMode.ClampToEdge)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureWrapT, int TextureWrapMode.ClampToEdge)
        Gl.FramebufferTexture2D (FramebufferTarget.Framebuffer, FramebufferAttachment.ColorAttachment0, TextureTarget.Texture2d, depthId, 0)
        Gl.BindTexture (TextureTarget.Texture2d, 0u)
        Hl.Assert ()
        ...
        Gl.TexImage2D (TextureTarget.Texture2d, 0, Hl.CheckRenderFormat InternalFormat.Rgba8, resolutionX, resolutionY, 0, PixelFormat.Rgba, PixelType.UnsignedByte, nativeint 0)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureMinFilter, int TextureMinFilter.Nearest)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureMagFilter, int TextureMagFilter.Nearest)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureWrapS, int TextureWrapMode.ClampToEdge)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureWrapT, int TextureWrapMode.ClampToEdge)
        ...
        // create clear coat plus buffer
        let clearCoatPlusId = Gl.GenTexture ()
        Gl.BindTexture (TextureTarget.Texture2d, clearCoatPlusId)
        Gl.TexImage2D (TextureTarget.Texture2d, 0, Hl.CheckRenderFormat InternalFormat.Rgba16f, resolutionX, resolutionY, 0, PixelFormat.Rgba, PixelType.HalfFloat, nativeint 0)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureMinFilter, int TextureMinFilter.Nearest)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureMagFilter, int TextureMagFilter.Nearest)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureWrapS, int TextureWrapMode.ClampToEdge)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureWrapT, int TextureWrapMode.ClampToEdge)
        Gl.FramebufferTexture2D (FramebufferTarget.Framebuffer, FramebufferAttachment.ColorAttachment6, TextureTarget.Texture2d, clearCoatPlusId, 0)
        Gl.BindTexture (TextureTarget.Texture2d, 0u)
        Hl.Assert ()
        ...
        Gl.DrawBuffers
            [|int FramebufferAttachment.ColorAttachment0
              ...
              int FramebufferAttachment.ColorAttachment6|]
        Hl.Assert ()
        ...
        if Gl.CheckFramebufferStatus FramebufferTarget.Framebuffer = FramebufferStatus.FramebufferComplete then
            ...
            let clearCoatPlus = Texture.EagerTexture { TextureMetadata = Texture.TextureMetadata.empty; TextureId = clearCoatPlusId }
            Right (depth, albedo, material, normalPlus, subdermalPlus, scatterPlus, clearCoatPlus, renderbuffer, framebuffer)
        else Left "Could not create complete geometry framebuffer."

    /// Destroy geometry buffers.
    let DestroyGeometryBuffers (position : Texture.Texture, albedo : Texture.Texture, material : Texture.Texture, normalPlus : Texture.Texture, subdermalPlus : Texture.Texture, scatterPlus : Texture.Texture, clearCoatPlus : Texture.Texture, renderbuffer, framebuffer) =
        Gl.DeleteRenderbuffers [|renderbuffer|]
        Gl.DeleteFramebuffers [|framebuffer|]
        position.Destroy ()
        albedo.Destroy ()
    ...
    let TryCreateSsaoBuffers (ssaoResolutionX, ssaoResolutionY) =
        ...
        Gl.TexImage2D (TextureTarget.Texture2d, 0, Hl.CheckRenderFormat InternalFormat.R16f, ssaoResolutionX, ssaoResolutionY, 0, PixelFormat.Red, PixelType.HalfFloat, nativeint 0)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureMinFilter, int TextureMinFilter.Nearest)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureMagFilter, int TextureMagFilter.Nearest)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureWrapS, int TextureWrapMode.ClampToEdge)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureWrapT, int TextureWrapMode.ClampToEdge)
    ...
    let TryCreateColoringBuffers (resolutionX, resolutionY) =
        ...
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureWrapS, int TextureWrapMode.ClampToEdge)
        Gl.TexParameter (TextureTarget.Texture2d, TextureParameterName.TextureWrapT, int TextureWrapMode.ClampToEdge)
        Gl.FramebufferTexture2D (FramebufferTarget.Framebuffer, FramebufferAttachment.ColorAttachment1, TextureTarget.Texture2d, depthId, 0)
        Gl.BindTexture (TextureTarget.Texture2d, 0u)
        Hl.Assert ()
