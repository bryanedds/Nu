...
module Render =
    ...
    let (*Literal*) VirtualResolutionOver2F = VirtualResolutionF / 2.0f
    ...
    let SpriteTexelEpsilonDivisor = 16384.0f // TODO: 3D: check if this is too large when zooming over tile maps.
