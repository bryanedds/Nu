...
module Engine =
    ...
    let (*Literal*) EntityOffset2dDefault = Vector3 (0.5f, 0.5f, 0.0f)
    let (*Literal*) EntityOffsetGuiDefault = Vector3 (0.5f, 0.5f, 0.0f)
    let (*Literal*) EntityOffset3dDefault = Vector3 (0.0f, 0.0f, 0.0f)
