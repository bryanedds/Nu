...
module WorldGroupModule =
    ...
    type Group with
        ...
        member this.SetModel<'a> value world = World.setGroupModel<'a> value this world
        ...
        member this.SetVisible value world = World.setGroupVisible value this world
        ...
        member this.Set<'a> propertyName (value : 'a) world = World.setGroupProperty propertyName { PropertyType = typeof<'a>; PropertyValue = value } this world
        ...
        static member createGroup3 descriptor screen world =
            ...
            let world =
                List.fold (fun world (propertyName, property) ->
                    World.setGroupProperty propertyName property group world)
