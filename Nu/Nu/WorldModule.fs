...
module WorldModule =
    ...
    type World with // Construction
        ...
        static member internal make eventSystem dispatchers subsystems scriptingEnv ambientState gameSpecializationOpt activeGameDispatcher =
            ...
            let screenStates = UMap.makeEmpty Functional
            let layerStates = UMap.makeEmpty Functional
            let entityStates = UMap.makeEmpty Functional
            let world =
                { EventSystem = eventSystem
                  ...
                  ScreenDirectory = UMap.makeEmpty Functional
