    ...
    module Scripting =
        ...
        let LogFns =
            { Bool = fun _ originOpt -> Violation (["InvalidArgumentType"; "Log"], "Cannot log a bool.", originOpt)
              ...
              Vector2 = fun value originOpt ->
                ...
                then Violation (["OutOfRangeArgument"; "Log"], "Cannot log a vector containing a zero member.", originOpt)
        ...
        let NormalFns =
            { Bool = fun _ originOpt -> Violation (["InvalidArgumentType"; "Normal"], "Cannot normalize a bool.", originOpt)
              ...
              Vector2 = fun value originOpt -> if value = Vector2.Zero then Violation (["OutOfRangeArgument"; "Normal"], "Cannot get the normal of a zero vector.", originOpt) else Vector2 (Vector2.Normalize value)
        ...
        let BoolFns =
            { Bool = fun value _ -> Bool (value)
              ...
              Vector2 = fun _ originOpt -> Violation (["InvalidArgumentType"; "Bool"], "Cannot convert a vector to a bool.", originOpt)
        ...
        let IntFns =
            { Bool = fun value _ -> Int (if value then 1 else 0)
              ...
              Vector2 = fun _ originOpt -> Violation (["InvalidArgumentType"; "Int"], "Cannot convert a vector to an int.", originOpt)
        ...
        let Int64Fns =
            { Bool = fun value _ -> Int64 (if value then 1L else 0L)
              ...
              Vector2 = fun _ originOpt -> Violation (["InvalidArgumentType"; "Int64"], "Cannot convert a vector to a 64-bit int.", originOpt)
        ...
        let SingleFns =
            { Bool = fun value _ -> Single (if value then 1.0f else 0.0f)
              ...
              Vector2 = fun _ originOpt -> Violation (["InvalidArgumentType"; "Single"], "Cannot convert a vector to a single.", originOpt)
        ...
        let DoubleFns =
            { Bool = fun value _ -> Double (if value then 1.0 else 0.0)
              ...
              Vector2 = fun _ originOpt -> Violation (["InvalidArgumentType"; "Double"], "Cannot convert a vector to a double.", originOpt)
        ...
        let StringFns =
            { Bool = fun value _ -> String (scstring value)
              ...
              Vector2 = fun _ originOpt -> Violation (["InvalidArgumentType"; "String"], "Cannot convert a v2 to a string.", originOpt)
        ...
        let evalBoolUnary fn fnName originOpt evaledArgs world =
        ...
        let evalUnaryInner (fns : UnaryFns) fnName originOpt evaledArg world =
            match evaledArg with
            ...
            | Vector2 vector2Value -> (fns.Vector2 vector2Value originOpt, world)
        ...
        let evalUnary fns fnName originOpt evaledArgs world =
            match evaledArgs with
