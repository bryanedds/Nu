                ...
                | Some textureData ->
                    ...
                    | Texture.TextureData.TextureDataDotNet (metadata, bytes) ->
                        let vulkanTexture =
                            ...
                            | None -> Texture.VulkanTexture.create Texture.Rgba Texture.Linear Texture.Linear false Texture.MipmapNone true Texture.Uncompressed metadata vkc
                    ...
                    | Texture.TextureData.TextureDataMipmap (metadata, compressed, bytes, _) ->
                        let vulkanTexture =
                            ...
                            | None ->
                                ...
                                Texture.VulkanTexture.create Texture.Rgba Texture.Linear Texture.Linear false Texture.MipmapNone true compression metadata vkc
                        vulkanTextureOpt <- Some vulkanTexture
                        Texture.VulkanTexture.uploadArray metadata 0 i bytes thread vulkanTexture vkc
