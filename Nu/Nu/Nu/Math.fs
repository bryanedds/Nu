...
type Vector2Converter () =
    ...
    override this.ConvertTo (_, _, source, destType) =
        if destType = typeof<Symbol> then
            ...
            Symbols [Number ^ string v2.X; Number ^ string v2.Y] :> obj
    ...
    override this.ConvertFrom (_, _, source) =
        ...
        | :? Symbol as symbol ->
            match symbol with
            | Symbols [Number x; Number y] -> Vector2 (Single.Parse x, Single.Parse y) :> obj
...
type Vector3Converter () =
    ...
    override this.ConvertTo (_, _, source, destType) =
        if destType = typeof<Symbol> then
            ...
            Symbols [Number ^ string v3.X; Number ^ string v3.Y; Number ^ string v3.Z] :> obj
    ...
    override this.ConvertFrom (_, _, source) =
        ...
        | :? Symbol as symbol ->
            match symbol with
            | Symbols [Number x; Number y; Number z] -> Vector3 (Single.Parse x, Single.Parse y, Single.Parse z) :> obj
...
type Vector4Converter () =
    ...
    override this.ConvertTo (_, _, source, destType) =
        if destType = typeof<Symbol> then
            ...
            Symbols [Number ^ string v4.X; Number ^ string v4.Y; Number ^ string v4.Z; Atom ^ string v4.W] :> obj
    ...
    override this.ConvertFrom (_, _, source) =
        ...
        | :? Symbol as symbol ->
            match symbol with
            | Symbols [Number x; Number y; Number z; Number w] -> Vector4 (Single.Parse x, Single.Parse y, Single.Parse z, Single.Parse w) :> obj
...
type Vector2iConverter () =
    ...
    override this.ConvertTo (_, _, source, destType) =
        if destType = typeof<Symbol> then
            ...
            Symbols [Number ^ string v2i.X; Number ^ string v2i.Y] :> obj
    ...
    override this.ConvertFrom (_, _, source) =
        ...
        | :? Symbol as symbol ->
            match symbol with
            | Symbols [Number x; Number y] -> Vector2i (Int32.Parse x, Int32.Parse y) :> obj
