...
module WorldEntityModule =
    ...
    type Entity with
        ...
        member this.GetPublishActualizes world = (World.getEntityState this world).PublishActualizes
        member this.SetPublishActualizes value world = World.updateEntityState (fun entityState -> { entityState with PublishActualizes = value }) this world
    ...
    type World with
        ...
        static member actualizeEntity (entity : Entity) world =
            ...
            if entity.GetPublishActualizes world
            then World.publish6 World.getSubscriptionsSpecific World.sortSubscriptionsNone () (Events.Actualize ->- entity) Simulants.Game world
            else world
