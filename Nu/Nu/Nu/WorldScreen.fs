...
module WorldScreenModule =
    ...
    type World with
        ...
        static member internal addScreen mayReplace screenState screen world =
            ...
            if isNew || mayReplace then
                ...
                if isNew then
                    ...
                    World.publish4 () (EventAddresses.ScreenAdd ->>- screen.ScreenAddress) screen world
                else world
        ...
        static member destroyScreenImmediate screen world =
            let world = World.publish4 () (EventAddresses.ScreenRemoving ->>- screen.ScreenAddress) screen world
