...
module Assets =
    ...
    let private getAssetAssociations (node : XmlNode) =
        ...
        | null -> []
        | associations ->
            let associations = TypeDescriptor.ConvertFromString associations.InnerText typeof<string list>
    ...
    let private getAssetSearchOption (node : XmlNode) =
        ...
        | isRecursive -> if isRecursive.InnerText = tcstring true then SearchOption.AllDirectories else SearchOption.TopDirectoryOnly
    ...
    let private getAssetRefinements (node : XmlNode) =
        ...
        | null -> []
        | refinements ->
            let refinements = TypeDescriptor.ConvertFromString refinements.InnerText typeof<string list>
