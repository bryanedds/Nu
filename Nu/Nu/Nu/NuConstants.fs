...
module NuConstants =
    ...
    let AnyEvent = addr "*"
    let StartedIncomingEvent = addr "Started/Incoming"
    let StartedOutgoingEvent = addr "Started/Outgoing"
    let FinishedIncomingEvent = addr "Finished/Incoming"
    let FinishedOutgoingEvent = addr "Finished/Outgoing"
    let SelectedEvent = addr "Selected"
    let DeselectedEvent = addr "Deselected"
