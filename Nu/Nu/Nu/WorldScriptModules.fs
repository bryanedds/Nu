...
module Scripting =
    ...
    module Violation =
        ...
        let make (categoriesStr : string, msg, optOrigin) =
            let categories = categoriesStr.Split [|'/'|] |> List.ofArray
            Violation (categories, msg, optOrigin)
    ...
    module Unary =
        ...
        let Sqr =
            { Bool = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/sqr", "Cannot square a bool.", optOrigin)
              ...
              String = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/sqr", "Cannot square a string.", optOrigin)
              List = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/sqr", "Cannot square a list.", optOrigin) }
    
        let Sqrt =
            { Bool = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/sqrt", "Cannot square root a bool.", optOrigin)
              ...
              String = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/sqrt", "Cannot square root a string.", optOrigin)
              List = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/sqrt", "Cannot square root a list.", optOrigin) }
    
        let Floor =
            { Bool = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/floor", "Cannot floor a bool.", optOrigin)
              ...
              String = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/floor", "Cannot floor a string.", optOrigin)
              List = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/floor", "Cannot floor a list.", optOrigin) }
    
        let Ceiling =
            { Bool = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/ceiling", "Cannot ceiling a bool.", optOrigin)
              ...
              String = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/ceiling", "Cannot ceiling a string.", optOrigin)
              List = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/ceiling", "Cannot ceiling a list.", optOrigin) }
    
        let Truncate =
            { Bool = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/truncate", "Cannot truncate a bool.", optOrigin)
              ...
              String = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/truncate", "Cannot truncate a string.", optOrigin)
              List = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/truncate", "Cannot truncate a list.", optOrigin) }
    
        let Exp =
            { Bool = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/exp", "Cannot exponentiate a bool.", optOrigin)
              ...
              String = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/exp", "Cannot exponentiate a string.", optOrigin)
              List = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/exp", "Cannot exponentiate a list.", optOrigin) }
    
        let Round =
            { Bool = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/round", "Cannot round a bool.", optOrigin)
              ...
              String = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/round", "Cannot round a string.", optOrigin)
              List = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/round", "Cannot round a list.", optOrigin) }
    
        let Log =
            { Bool = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/log", "Cannot log a bool.", optOrigin)
              Int = fun value optOrigin -> if value = 0 then Violation.make ("invalidArgumentValue/unary/log", "Cannot log a zero int.", optOrigin) else Int (int ^ Math.Log (double value), optOrigin)
              Int64 = fun value optOrigin -> if value = 0L then Violation.make ("invalidArgumentValue/unary/log", "Cannot log a zero 64-bit int.", optOrigin) else Int64 (int64 ^ Math.Log (double value), optOrigin)
              Single = fun value optOrigin -> if value = 0.0f then Violation.make ("invalidArgumentValue/unary/log", "Cannot log a zero single.", optOrigin) else Single (single ^ Math.Log (double value), optOrigin)
              Double = fun value optOrigin -> if value = 0.0 then Violation.make ("invalidArgumentValue/unary/log", "Cannot log a zero double.", optOrigin) else Double (Math.Log value, optOrigin)
              Vector2 = fun value optOrigin -> if value.X = 0.0f || value.Y == 0.0f then Violation.make ("invalidArgumentValue/unary/log", "Cannot log a vector containing a zero member.", optOrigin) else Vector2 (OpenTK.Vector2 (single ^ Math.Log (double value.X), single ^ Math.Log (double value.Y)), optOrigin)
              String = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/log", "Cannot log a string.", optOrigin)
              List = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/log", "Cannot log a list.", optOrigin) }
    
        let Sin =
            { Bool = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/sin", "Cannot sin a bool.", optOrigin)
              ...
              String = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/sin", "Cannot sin a string.", optOrigin)
              List = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/sin", "Cannot sin a list.", optOrigin) }
    
        let Cos =
            { Bool = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/cos", "Cannot cos a bool.", optOrigin)
              ...
              String = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/cos", "Cannot cos a string.", optOrigin)
              List = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/cos", "Cannot cos a list.", optOrigin) }
    
        let Tan =
            { Bool = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/tan", "Cannot tan a bool.", optOrigin)
              ...
              String = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/tan", "Cannot tan a string.", optOrigin)
              List = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/tan", "Cannot tan a list.", optOrigin) }
    
        let Asin =
            { Bool = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/asin", "Cannot asin a bool.", optOrigin)
              ...
              String = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/asin", "Cannot asin a string.", optOrigin)
              List = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/asin", "Cannot asin a list.", optOrigin) }
    
        let Acos =
            { Bool = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/acos", "Cannot acos a bool.", optOrigin)
              ...
              String = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/acos", "Cannot acos a string.", optOrigin)
              List = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/acos", "Cannot acos a list.", optOrigin) }
    
        let Atan =
            { Bool = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/atan", "Cannot atan a bool.", optOrigin)
              ...
              String = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/atan", "Cannot atan a string.", optOrigin)
              List = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/atan", "Cannot atan a list.", optOrigin) }
    
        let Length =
            { Bool = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/length", "Cannot get length of a bool.", optOrigin)
        ...
        let Normal =
            { Bool = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/normal", "Cannot normalize a bool.", optOrigin)
              Int = fun value optOrigin -> if value = 0 then Violation.make ("invalidArgumentValue/unary/normal", "Cannot get the normal of a zero int.", optOrigin) elif value < 0 then Int (-1, optOrigin) else Int (1, optOrigin)
              Int64 = fun value optOrigin -> if value = 0L then Violation.make ("invalidArgumentValue/unary/normal", "Cannot get the normal of a zero 64-bit int.", optOrigin) elif value < 0L then Int64 (-1L, optOrigin) else Int64 (1L, optOrigin)
              Single = fun value optOrigin -> if value = 0.0f then Violation.make ("invalidArgumentValue/unary/normal", "Cannot get the normal of a zero single.", optOrigin) elif value < 0.0f then Single (-1.0f, optOrigin) else Single (1.0f, optOrigin)
              Double = fun value optOrigin -> if value = 0.0 then Violation.make ("invalidArgumentValue/unary/normal", "Cannot get the normal of a zero double.", optOrigin) elif value < 0.0 then Double (-1.0, optOrigin) else Double (1.0, optOrigin)
              Vector2 = fun value optOrigin -> if value = Vector2.Zero then Violation.make ("invalidArgumentValue/unary/normal", "Cannot get the normal of a zero vector.", optOrigin) else Vector2 (Vector2.Normalize value, optOrigin)
              String = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/normal", "Cannot normalize a string.", optOrigin)
              List = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/normal", "Cannot normalize a list.", optOrigin) }
        ...
        let Bool =
            { Bool = fun value optOrigin -> Bool (value, optOrigin)
              ...
              Vector2 = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/conversion/bool", "Cannot convert a vector to a bool.", optOrigin)
              String = fun value optOrigin -> Bool (scvalue value, optOrigin)
              List = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/conversion/bool", "Cannot convert a list to a bool.", optOrigin) }
        ...
        let Int =
            { Bool = fun value optOrigin -> Int ((if value then 1 else 0), optOrigin)
              ...
              Vector2 = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/conversion/int", "Cannot convert a vector to an int.", optOrigin)
              String = fun value optOrigin -> Int (scvalue value, optOrigin)
              List = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/conversion/int", "Cannot convert a list to an int.", optOrigin) }
        ...
        let Int64 =
            { Bool = fun value optOrigin -> Int64 ((if value then 1L else 0L), optOrigin)
              ...
              Vector2 = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/conversion/int64", "Cannot convert a vector to a 64-bit int.", optOrigin)
              String = fun value optOrigin -> Int64 (scvalue value, optOrigin)
              List = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/conversion/int64", "Cannot convert a list to a 64-bit int.", optOrigin) }
        ...
        let Single =
            { Bool = fun value optOrigin -> Single ((if value then 1.0f else 0.0f), optOrigin)
              ...
              Vector2 = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/conversion/single", "Cannot convert a vector to a single.", optOrigin)
              String = fun value optOrigin -> Single (scvalue value, optOrigin)
              List = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/conversion/single", "Cannot convert a list to a single.", optOrigin) }
        ...
        let Double =
            { Bool = fun value optOrigin -> Double ((if value then 1.0 else 0.0), optOrigin)
              ...
              Vector2 = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/conversion/double", "Cannot convert a vector to a double.", optOrigin)
              String = fun value optOrigin -> Double (scvalue value, optOrigin)
              List = fun _ optOrigin -> Violation.make ("invalidArgumentType/unary/conversion/double", "Cannot convert a list to a double.", optOrigin) }
    ...
    module Binary =
        ...
        let Lt =
            { Bool = fun left right optOrigin -> Bool ((left < right), optOrigin)
              ...
              String = fun left right optOrigin -> Bool ((left < right), optOrigin)
              List = fun _ _ optOrigin -> Violation.make ("invalidArgumentType/binary/comparison/lt", "Cannot compare lists.", optOrigin) }
        ...
        let Gt =
            { Bool = fun left right optOrigin -> Bool ((left > right), optOrigin)
              ...
              Vector2 = fun left right optOrigin -> Bool ((left.LengthSquared > right.LengthSquared), optOrigin)
              String = fun left right optOrigin -> Bool ((left > right), optOrigin)
              List = fun _ _ optOrigin -> Violation.make ("invalidArgumentType/binary/comparison/gt", "Cannot compare lists.", optOrigin) }
        ...
        let LtEq =
            { Bool = fun left right optOrigin -> Bool ((left <= right), optOrigin)
              ...
              Vector2 = fun left right optOrigin -> Bool ((left.LengthSquared <= right.LengthSquared), optOrigin)
              String = fun left right optOrigin -> Bool ((left <= right), optOrigin)
              List = fun _ _ optOrigin -> Violation.make ("invalidArgumentType/binary/comparison/lt_eq", "Cannot compare lists.", optOrigin) }
        ...
        let GtEq =
            { Bool = fun left right optOrigin -> Bool ((left >= right), optOrigin)
              ...
              Vector2 = fun left right optOrigin -> Bool ((left.LengthSquared >= right.LengthSquared), optOrigin)
              String = fun left right optOrigin -> Bool ((left >= right), optOrigin)
              List = fun _ _ optOrigin -> Violation.make ("invalidArgumentType/binary/comparison/gt_eq", "Cannot compare lists.", optOrigin) }
        ...
        let Sub =
            { Bool = fun left right optOrigin -> Bool ((if left && right then false elif left then true elif right then true else false), optOrigin)
              ...
              List = fun _ _ optOrigin -> Violation.make ("invalidArgumentType/binary/sub", "Cannot subtract lists. TODO: implement this like string subtraction!", optOrigin) }
    
        let Mul =
            { Bool = fun _ _ optOrigin -> Violation.make ("invalidArgumentType/binary/mul", "Cannot multiply bools.", optOrigin)
              Int = fun left right optOrigin -> Int ((left * right), optOrigin)
              Int64 = fun left right optOrigin -> Int64 ((left * right), optOrigin)
              Single = fun left right optOrigin -> Single ((left * right), optOrigin)
              Double = fun left right optOrigin -> Double ((left * right), optOrigin)
              Vector2 = fun left right optOrigin -> Vector2 (Vector2.Multiply (left, right), optOrigin)
              String = fun _ _ optOrigin -> Violation.make ("invalidArgumentType/binary/mul", "Cannot multiply strings.", optOrigin)
              List = fun _ _ optOrigin -> Violation.make ("invalidArgumentType/binary/mul", "Cannot multiply lists.", optOrigin) }
    
        let Div =
            { Bool = fun left right optOrigin -> if right = false then Violation.make ("invalidArgumentValue/binary/div", "Cannot divide by a false bool.", optOrigin) else Bool ((if left && right then true else false), optOrigin)
              Int = fun left right optOrigin -> if right = 0 then Violation.make ("invalidArgumentValue/binary/div", "Cannot divide by a zero int.", optOrigin) else Int ((left / right), optOrigin)
              Int64 = fun left right optOrigin -> if right = 0L then Violation.make ("invalidArgumentValue/binary/div", "Cannot divide by a zero 64-bit int.", optOrigin) else Int64 ((left / right), optOrigin)
              Single = fun left right optOrigin -> Single ((left / right), optOrigin)
              Double = fun left right optOrigin -> Double ((left / right), optOrigin)
              Vector2 = fun left right optOrigin -> Vector2 (Vector2.Divide (left, right), optOrigin)
              String = fun _ _ optOrigin -> Violation.make ("invalidArgumentType/binary/div", "Cannot divide strings.", optOrigin)
              List = fun _ _ optOrigin -> Violation.make ("invalidArgumentType/binary/div", "Cannot divide lists.", optOrigin) }
    
        let Mod =
            { Bool = fun _ _ optOrigin -> Violation.make ("invalidArgumentType/binary/mod", "Cannot modulate bools.", optOrigin)
              Int = fun left right optOrigin -> if right = 0 then Violation.make ("invalidArgumentValue/binary/mod", "Cannot modulate by a zero int.", optOrigin) else Int ((left % right), optOrigin)
              Int64 = fun left right optOrigin -> if right = 0L then Violation.make ("invalidArgumentValue/binary/mod", "Cannot divide by a zero 64-bit int.", optOrigin) else Int64 ((left % right), optOrigin)
              Single = fun left right optOrigin -> Single ((left % right), optOrigin)
              Double = fun left right optOrigin -> Double ((left % right), optOrigin)
              Vector2 = fun left right optOrigin -> Vector2 (OpenTK.Vector2 (left.X % right.X, left.Y % right.Y), optOrigin)
              String = fun _ _ optOrigin -> Violation.make ("invalidArgumentType/binary/mod", "Cannot modulate strings.", optOrigin)
              List = fun _ _ optOrigin -> Violation.make ("invalidArgumentType/binary/mod", "Cannot modulate lists.", optOrigin) }
    
        let Pow =
            { Bool = fun _ _ optOrigin -> Violation.make ("invalidArgumentType/binary/pow", "Cannot power bools.", optOrigin)
              ...
              String = fun _ _ optOrigin -> Violation.make ("invalidArgumentType/binary/pow", "Cannot power strings.", optOrigin)
              List = fun _ _ optOrigin -> Violation.make ("invalidArgumentType/binary/pow", "Cannot power lists.", optOrigin) }
    
        let Root =
            { Bool = fun _ _ optOrigin -> Violation.make ("invalidArgumentType/binary/root", "Cannot root bools.", optOrigin)
              ...
              String = fun _ _ optOrigin -> Violation.make ("invalidArgumentType/binary/root", "Cannot root strings.", optOrigin)
              List = fun _ _ optOrigin -> Violation.make ("invalidArgumentType/binary/root", "Cannot root lists.", optOrigin) }
    
        let Cross =
            { Bool = fun _ _ optOrigin -> Violation.make ("invalidArgumentType/binary/cross", "Cannot cross multiply bools.", optOrigin)
              Int = fun left right optOrigin -> Int ((left * right), optOrigin)
              Int64 = fun left right optOrigin -> Int64 ((left * right), optOrigin)
              Single = fun left right optOrigin -> Single ((left * right), optOrigin)
              Double = fun left right optOrigin -> Double ((left * right), optOrigin)
              Vector2 = fun _ _ optOrigin -> Violation.make ("invalidArgumentType/binary/cross", "Cannot cross multiply 2-dimensional vectors.", optOrigin)
              String = fun _ _ optOrigin -> Violation.make ("invalidArgumentType/binary/cross", "Cannot cross multiply strings.", optOrigin)
              List = fun _ _ optOrigin -> Violation.make ("invalidArgumentType/binary/cross", "Cannot cross multiply lists.", optOrigin) }
    
        let Dot =
            { Bool = fun _ _ optOrigin -> Violation.make ("invalidArgumentType/binary/dot", "Cannot dot multiply bools.", optOrigin)
              Int = fun left right optOrigin -> Int ((left * right), optOrigin)
              Int64 = fun left right optOrigin -> Int64 ((left * right), optOrigin)
              Single = fun left right optOrigin -> Single ((left * right), optOrigin)
              Double = fun left right optOrigin -> Double ((left * right), optOrigin)
              Vector2 = fun left right optOrigin -> Single (Vector2.Dot (left, right), optOrigin)
              String = fun _ _ optOrigin -> Violation.make ("invalidArgumentType/binary/dot", "Cannot dot multiply strings.", optOrigin)
              List = fun _ _ optOrigin -> Violation.make ("invalidArgumentType/binary/dot", "Cannot dot multiply lists.", optOrigin) }
    ...
    let evalBoolUnary fnOptOrigin fnName fn evaledArgs env =
        ...
        | [evaled] ->
            ...
            | _ -> Result (Violation.make ("invalidArgumentType/unary/" + fnName, "Cannot apply a bool function to a non-bool value.", Expr.getOptOrigin evaled), env)
        | _ -> Result (Violation.make ("invalidArgumentCount/unary/" + fnName, "Incorrect number of arguments for application of '" + fnName + "'; 1 argument required.", fnOptOrigin), env)
    ...
    let evalBoolBinary fnOptOrigin fnName fn evaledArgs env =
        ...
        | [evaledLeft; evaledRight] ->
            ...
            | _ -> Result (Violation.make ("invalidArgumentType/binary/" + fnName, "Cannot apply a bool function to a non-bool value.", combine (Expr.getOptOrigin evaledLeft) (Expr.getOptOrigin evaledRight)), env)
        | _ -> Result (Violation.make ("invalidArgumentCount/binary/" + fnName, "Incorrect number of arguments for application of '" + fnName + "'; 2 arguments required.", fnOptOrigin), env)
    ...
    let evalUnary fnOptOrigin fnName (fns : Unary.Fns) evaledArgs env =
        ...
        | [evaled] ->
            ...
            | _ -> Result (Violation.make ("invalidArgumentType/unary/" + fnName, "Cannot apply an unary function on an incompatible value.", Expr.getOptOrigin evaled), env)
        | _ -> Result (Violation.make ("invalidArgumentCount/unary/" + fnName, "Incorrect number of arguments for application of '" + fnName + "'; 1 argument required.", fnOptOrigin), env)
    ...
    let evalBinary fnOptOrigin fnName (fns : Binary.Fns) evaledArgs env =
        ...
        | [evaledLeft; evaledRight] ->
            ...
            | _ -> Result (Violation.make ("invalidArgumentType/binary/" + fnName, "Cannot apply a binary function on unlike or incompatible values.", combine (Expr.getOptOrigin evaledLeft) (Expr.getOptOrigin evaledRight)), env)
        | _ -> Result (Violation.make ("invalidArgumentCount/binary/" + fnName, "Incorrect number of arguments for application of '" + fnName + "'; 2 arguments required.", fnOptOrigin), env)
        
    let evalSome fnOptOrigin fnName args env =
        match args with
        | [evaled] -> Result (Option (Some evaled, fnOptOrigin), env)
        | _ -> Result (Violation.make ("invalidArgumentCount/option/" + fnName, "Incorrect number of arguments for application of '" + fnName + "'; 1 argument required.", fnOptOrigin), env)
    
    let evalIsSome fnOptOrigin fnName args env =
        match args with
        | [Option (evaled, optOrigin)] -> Result (Bool (Option.isSome evaled, optOrigin), env)
        | [_] -> Result (Violation.make ("invalidArgumentType/list/" + fnName, "Cannot apply " + fnName + " to a non-list.", fnOptOrigin), env)
        | _ -> Result (Violation.make ("invalidArgumentCount/list/" + fnName, "Incorrect number of arguments for application of '" + fnName + "'; 1 argument required.", fnOptOrigin), env)
    ...
    let evalHead fnOptOrigin fnName args env =
        ...
        | [List (evaleds, _)] ->
            ...
            | _ -> Result (Violation.make ("invalidArgumentValue/list/" + fnName, "Cannot apply " + fnName + " to a list with no members.", fnOptOrigin), env)
        | [_] -> Result (Violation.make ("invalidArgumentType/list/" + fnName, "Cannot apply " + fnName + " to a non-list.", fnOptOrigin), env)
        | _ -> Result (Violation.make ("invalidArgumentCount/list/" + fnName, "Incorrect number of arguments for application of '" + fnName + "'; 1 argument required.", fnOptOrigin), env)
    ...
    let evalCons fnOptOrigin fnName args env =
        ...
        | [_; _] -> Result (Violation.make ("invalidArgumentType/list/" + fnName, "Cannot apply " + fnName + " to a non-list.", fnOptOrigin), env)
        | _ -> Result (Violation.make ("invalidArgumentCount/list/" + fnName, "Incorrect number of arguments for application of '" + fnName + "'; 1 argument required.", fnOptOrigin), env)
    ...
    let evalIntrinsic optOrigin name args env =
        ...
        | _ -> Result (Violation.make ("invalidFunctionTargetBinding", "Cannot apply an non-existent binding.", optOrigin), env)
    ...
    and evalCall exprs optOrigin env =
        ...
        | _ ->
            ...
            | fn :: args ->
                ...
                | Get (name, optOrigin) ->
                    ...
                    | [Entity (entity, optOrigin)] ->
                        ...
                        if World.containsEntity entity world then
                            ...
                            | (false, _) -> Result (Violation.make ("unsupportedPropertyType", "TODO: proper error msg.", optOrigin), env)
                        else Result (Violation.make ("invalidEntity", "Entity '" + scstring entity + "' does not exist.", optOrigin), env)
                    | [_] -> Result (Violation.make ("invalidGetTargetType", "TODO: proper error msg.", optOrigin), env)
                    | _ -> Result (Violation.make ("invalidGetForm", "TODO: proper error msg.", optOrigin), env)
                ...
                | _ -> Result (Violation.make ("TODO: proper violation category.", "Cannot apply a non-binding.", optOrigin), env)
    ...
    and evalIf condition consequent alternative optOrigin env =
        ...
        | _ -> Result (Violation.make ("invalidIfCondition", "Must provide an expression that evaluates to a bool in an if condition.", optOrigin), env)
    ...
    and evalCase exprPairs optOrigin env =
        List.foldUntil
            (fun (result : Result) (condition, consequent) ->
                ...
                | _ -> Some (Result (Violation.make ("invalidCaseCondition", "Must provide an expression that evaluates to a bool in a case condition.", optOrigin), env)))
            (Result (Unit optOrigin, env))
            exprPairs
