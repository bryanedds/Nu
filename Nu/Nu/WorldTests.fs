...
module WorldTests =
    ...
    let [<Fact>] iterativeFrpWorks () =
        let world = World.makeDefault ()
        let world = World.createEntity (Some Jim.EntityName) (None, ()) DefaultLayer world |> snd
        let world = World.createEntity (Some Bob.EntityName) (None, ()) DefaultLayer world |> snd
