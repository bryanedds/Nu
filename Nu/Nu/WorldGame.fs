...
module WorldGameModule =
    ...
    type Game with
        ...
        member this.GetDesiredScreens world = World.getDesiredScreens world
        member this.SetDesiredScreens value world = World.setDesiredScreens value world |> snd'
        member this.DesiredScreens = lens Property? DesiredScreens this.GetDesiredScreens this.SetDesiredScreens this
