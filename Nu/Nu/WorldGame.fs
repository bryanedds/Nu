...
module WorldGameModule =
    ...
    type Game with
        ...
        member internal this.GetScriptFrameNp world = World.getGameScriptFrameNp world
        member internal this.SetScriptFrameNp value world = World.setGameScriptFrameNp value world
