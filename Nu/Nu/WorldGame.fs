...
module WorldGameModule =
    ...
    type Game with
        ...
        member this.GetEyeFrustumEnclosed3d world = World.getEyeFrustumEnclosed3d world
        member this.EyeFrustumEnclosed3d = lensReadOnly Property? EyeFrustum3d this.GetEyeFrustumEnclosed3d this
        member this.GetEyeFrustumUnenclosed3d world = World.getEyeFrustumUnenclosed3d world
        member this.EyeFrustumUnenclosed3d = lensReadOnly Property? EyeFrustum3d this.GetEyeFrustumUnenclosed3d this
