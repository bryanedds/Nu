...
module WorldGameModule =
    ...
    type Game with
        ...
        member this.Id = Lens.makeReadOnly this Property? Id this.GetId
        member this.GetDispatcher world = World.getGameDispatcher world
        member this.Dispatcher = Lens.makeReadOnly this Property? Dispatcher this.GetDispatcher
        member this.GetCreationTimeStamp world = World.getGameCreationTimeStamp world
        member this.CreationTimeStamp = Lens.makeReadOnly this Property? CreationTimeStamp this.GetCreationTimeStamp
        member this.GetImperative world = World.getGameImperative world
        member this.Imperative = Lens.makeReadOnly this Property? Imperative this.GetImperative
        ...
        member this.ScriptOpt = Lens.make this Property? ScriptOpt this.GetScriptOpt this.SetScriptOpt
        member this.GetScript world = World.getGameScript world
        member this.SetScript value world = World.setGameScript value world
        member this.Script = Lens.make this Property? Script this.GetScript this.SetScript
        member this.GetScriptFrame world = World.getGameScriptFrame world
        member this.ScriptFrame = Lens.makeReadOnly this Property? Script this.GetScriptFrame
        ...
        member internal this.ScriptUnsubscriptions = Lens.make this Property? ScriptUnsubscriptions this.GetScriptUnsubscriptions this.SetScriptUnsubscriptions
        ...
        member this.OnRegister = Lens.make this Property? OnRegister this.GetOnRegister this.SetOnRegister
        ...
        member this.OnUnregister = Lens.make this Property? OnUnregister this.GetOnUnregister this.SetOnUnregister
        ...
        member this.OnUpdate = Lens.make this Property? OnUpdate this.GetOnUpdate this.SetOnUpdate
        ...
        member this.OnPostUpdate = Lens.make this Property? OnPostUpdate this.GetOnPostUpdate this.SetOnPostUpdate
        ...
        member this.OnMessage = Lens.make this Property? OnMessage this.GetOnMessage this.SetOnMessage
        ...
        member this.OmniscreenOpt = Lens.make this Property? OmniscreenOpt this.GetOmniscreenOpt this.SetOmniscreenOpt
        ...
        member this.SelectedScreenOpt = Lens.make this Property? SelectedScreenOpt this.GetSelectedScreenOpt this.SetSelectedScreenOpt
        ...
        member this.ScreenTransitionDestinationOpt = Lens.make this Property? ScreenTransitionDestinationOpt this.GetScreenTransitionDestinationOpt this.SetScreenTransitionDestinationOpt
        ...
        member this.EyeCenter = Lens.make this Property? EyeCenter this.GetEyeCenter this.SetEyeCenter
        member this.GetEyeSize world = World.getEyeSize world
        member this.SetEyeSize value world = World.setEyeSize value world
        member this.EyeSize = Lens.make this Property? EyeSize this.GetEyeSize this.SetEyeSize
