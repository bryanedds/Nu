...
module WorldScreenModule =
    ...
    type Screen with
        ...
        member internal this.Script = PropertyTag.make this Property? Script this.GetScript this.SetScript
        member internal this.GetScriptFrameNp world = World.getScreenScriptFrameNp this world
        member internal this.SetScriptFrameNp value world = World.setScreenScriptFrameNp value this world
