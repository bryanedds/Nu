...
type ImGui (stub : bool, displaySize : Vector2i) =
    ...
    static member StyleColorsAdobeInspired (alpha : bool) (focused : bool) =
        ...
        colors.[int ImGuiCol.Button] <- Vector4 (0.1490196138620377f, 0.1490196138620377f, 0.1490196138620377f, 1.0f)
        colors.[int ImGuiCol.ButtonHovered] <- Vector4 (0.2470588237047195f, 0.2470588237047195f, 0.2470588237047195f, 1.0f)
        colors.[int ImGuiCol.ButtonActive] <- Vector4 (0.3294117748737335f, 0.3294117748737335f, 0.3294117748737335f, 1.0f)
        colors.[int ImGuiCol.Header] <- Vector4 (0.9764705896377563f, 0.9764705896377563f, 0.9764705896377563f, 0.3098039329051971f)
        colors.[int ImGuiCol.HeaderHovered] <- Vector4 (0.9764705896377563f, 0.9764705896377563f, 0.9764705896377563f, 0.800000011920929f)
        colors.[int ImGuiCol.HeaderActive] <- Vector4 (0.9764705896377563f, 0.9764705896377563f, 0.9764705896377563f, 1.0f)
