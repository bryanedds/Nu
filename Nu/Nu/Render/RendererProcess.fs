            ...
            | None ->
                ...
                | Some window ->
                    ...
                    let empty = 
                        ...
                        | Some filePath ->
                            match Texture.TryCreateTextureVulkan (true, Vulkan.VK_FILTER_NEAREST, Vulkan.VK_FILTER_NEAREST, false, false, Texture.Uncompressed, filePath, Texture.MainTextureThread, vkc) with
                    ...
                    // create 3d renderer
                    let renderer3d = VulkanRenderer3d.make vkc :> Renderer3d
