            ...
            | None ->
                ...
                | Some window ->
                    ...
                    let empty = 
                        ...
                        | Some filePath ->
                            match Texture.TryCreateTextureVulkan (true, Vulkan.VK_FILTER_NEAREST, Vulkan.VK_FILTER_NEAREST, false, false, Texture.Uncompressed, filePath, Texture.RenderThread, vkc) with
