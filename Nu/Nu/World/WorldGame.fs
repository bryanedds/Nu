...
module WorldGameModule =
    ...
    type Game with
        ...
        member this.EyeFrustum3dExposed = lensReadOnly Property? EyeFrustum3dExposed this.GetEyeFrustum3dExposed this
        member this.GetEyeFrustum3dImposter world = World.getEyeFrustum3dImposter world
        member this.EyeFrustum3dImposter = lensReadOnly Property? EyeFrustum3dImposter this.GetEyeFrustum3dImposter this
