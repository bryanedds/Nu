...
module WorldGameModule =
    ...
    type Game with
        ...
        member this.GetEyeFrustumAfatecs3d world = World.getEyeFrustumAfatecs3d world
        member this.EyeFrustumAfatecs3d = lensReadOnly Property? EyeFrustum3d this.GetEyeFrustumAfatecs3d this
