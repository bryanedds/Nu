...
module WorldGameModule =
    ...
    type Game with
        ...
        member this.GetEye2dPosition world = World.getEye2dPosition world
        member this.SetEye2dPosition value world = World.setEye2dPositionPlus value world |> snd'
        member this.Eye2dPosition = lens Property? Eye2dPosition this.GetEye2dPosition this.SetEye2dPosition this
        member this.GetEye2dSize world = World.getEye2dSize world
        member this.SetEye2dSize value world = World.setEye2dSizePlus value world |> snd'
        member this.Eye2dSize = lens Property? Eye2dSize this.GetEye2dSize this.SetEye2dSize this
        member this.GetEye3dPosition world = World.getEye3dPosition world
        member this.SetEye3dPosition value world = World.setEye3dPositionPlus value world |> snd'
        member this.Eye3dPosition = lens Property? Eye3dPosition this.GetEye3dPosition this.SetEye3dPosition this
        member this.GetEye3dRotation world = World.getEye3dRotation world
        member this.SetEye3dRotation value world = World.setEye3dRotationPlus value world |> snd'
        member this.Eye3dRotation = lens Property? Eye3dRotation this.GetEye3dRotation this.SetEye3dRotation this
        member this.GetEye3dFrustumEnclosed world = World.getEye3dFrustumEnclosed world
        member this.Eye3dFrustumEnclosed = lensReadOnly Property? Eye3dFrustumEnclosed this.GetEye3dFrustumEnclosed this
        member this.GetEye3dFrustumUnenclosed world = World.getEye3dFrustumUnenclosed world
        member this.Eye3dFrustumUnenclosed = lensReadOnly Property? Eye3dFrustumUnenclosed this.GetEye3dFrustumUnenclosed this
        member this.GetEye3dFrustumProminent world = World.getEye3dFrustumProminent world
        member this.Eye3dFrustumProminent = lensReadOnly Property? Eye3dFrustum this.GetEye3dFrustumProminent this
