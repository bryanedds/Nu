...
module WorldGameModule =
    ...
    type Game with
        ...
        member this.SetScreenTransitionDestinationOpt value world = World.setScreenTransitionDestinationOpt value world |> snd'
        ...
        member this.GetViewBounds2dAbsolute world = World.getViewBounds2dAbsolute world
        member this.GetViewBounds2dRelative world = World.getViewBounds2dRelative world
        member this.GetPlayBounds2dAbsolute world = World.getPlayBounds2dAbsolute world
        member this.GetPlayBounds2dRelative world = World.getPlayBounds2dRelative world
        ...
        member this.GetLightBox3d world = World.getLightBox3d world
        member this.LightBox3d = lensReadOnly (nameof this.LightBox3d) this this.GetLightBox3d
        member this.GetPlayBounds3d world = World.getPlayBounds3d world
