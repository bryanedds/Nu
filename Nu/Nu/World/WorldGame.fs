...
module WorldGameModule =
    ...
    type Game with
        ...
        member this.EyeFrustum3dEnclosed = lensReadOnly Property? EyeFrustum3dEnclosed this.GetEyeFrustum3dEnclosed this
        member this.GetEyeFrustum3dUnenclosed world = World.getEyeFrustum3dUnenclosed world
        member this.EyeFrustum3dUnenclosed = lensReadOnly Property? EyeFrustum3dUnenclosed this.GetEyeFrustum3dUnenclosed this
        member this.GetEyeFrustum3dProminent world = World.getEyeFrustum3dProminent world
        member this.EyeFrustum3dProminent = lensReadOnly Property? EyeFrustum3d this.GetEyeFrustum3dProminent this
