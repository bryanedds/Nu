...
module WorldGameModule =
    ...
    type Game with
        ...
        member this.GetEyeFrustumProminent3d world = World.getEyeFrustumProminent3d world
        member this.EyeFrustumProminent3d = lensReadOnly Property? EyeFrustum3d this.GetEyeFrustumProminent3d this
