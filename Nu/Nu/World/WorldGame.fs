...
module WorldGameModule =
    ...
    type Game with
        ...
        member this.EyePosition2d = lens (nameof this.EyePosition2d) this this.GetEyePosition2d this.SetEyePosition2d
        ...
        member this.GetEyeCentered2d world = World.getEyeCentered2d world
        member this.SetEyeCentered2d value world = World.setEyeCentered2dPlus value world |> snd'
        member this.EyeCentered2d = lens (nameof this.EyeCentered2d) this this.GetEyeCentered2d this.SetEyeCentered2d
        ...
        member this.EyePosition3d = lens (nameof this.EyePosition3d) this this.GetEyePosition3d this.SetEyePosition3d
