...
and [<ReferenceEquality; CLIMutable>] EntityState =
    ...
    static member make mountOpt surnamesOpt overlayNameOpt (dispatcher : EntityDispatcher) =
...
and [<ReferenceEquality>] internal WorldExtension =
    { // cache line 1 (assuming 16 byte header)
      ...
      mutable SimulantJournals : SDictionary<Address, SimulantJournal>
      mutable SubscriptionJournals : SDictionary<string * Address * Address, SubscriptionJournal>
      JobGraph : JobGraph
