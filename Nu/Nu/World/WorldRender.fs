...
module WorldRender =
    ...
    type World with
        ...
        static member renderAnimatedModelFast (gameTime, absolute, modelMatrix : Matrix4x4 inref, presence, insetOpt, materialProperties : MaterialProperties inref, animations, animatedModel, world) =
            (World.getRendererProcess world).RenderAnimatedModelFast (gameTime, absolute, &modelMatrix, presence, insetOpt, &materialProperties, animations, animatedModel)
            world
