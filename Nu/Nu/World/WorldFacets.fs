...
type LightProbe3dFacet () =
    ...
    static let handleProbeVisibleChange (evt : Event<ChangeData, Entity>) world =
        ...
        if evt.Data.Value :?> bool && entity.Group.GetShown world then entity.SetProbeStale true world
        Cascade
    ...
    override this.Register (entity, world) =
        World.sense handleProbeVisibleChange entity.Group.Shown.ChangeEvent entity (nameof LightProbe3dFacet) world
