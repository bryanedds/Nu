...
module Assets =
    ...
    module Default =
        ...
        let (*Literal*) HighlightImage = asset<Image> PackageName Assets.Default.HighlightImageName
        ...
        let (*Literal*) MaterialAlbedo = asset<Image> PackageName Assets.Default.MaterialAlbedoName
        let (*Literal*) MaterialMetalness = asset<Image> PackageName Assets.Default.MaterialMetalnessName
        let (*Literal*) MaterialRoughness = asset<Image> PackageName Assets.Default.MaterialRoughnessName
        let (*Literal*) MaterialAmbientOcclusion = asset<Image> PackageName Assets.Default.MaterialAmbientOcclusionName
        let (*Literal*) MaterialNormal = asset<Image> PackageName Assets.Default.MaterialNormalName
