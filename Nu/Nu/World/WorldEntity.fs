...
module WorldEntityModule =
    ...
    module private Cached =
        ...
        let mutable Min = Unchecked.defaultof<Lens<Vector3, Entity, World>>
        let mutable Max = Unchecked.defaultof<Lens<Vector3, Entity, World>>
        ...
        let mutable MinLocal = Unchecked.defaultof<Lens<Vector3, Entity, World>>
        let mutable MaxLocal = Unchecked.defaultof<Lens<Vector3, Entity, World>>
        ...
        let mutable IsGui = Unchecked.defaultof<Lens<bool, Entity, World>>
    ...
    type Entity with
        ...
        member this.GetIsGui world = World.getEntityIsGui this world
        member this.IsGui = if notNull (this :> obj) then lensReadOnly (nameof this.IsGui) this this.GetIsGui else Cached.IsGui
        ...
        static member internal init () =
            ...
            Cached.IsGui <- lensReadOnly (nameof Cached.IsGui) Unchecked.defaultof<_> Unchecked.defaultof<_>
