...
module WorldEntityModule =
    ...
    module Entity =
        ...
        let Dispatcher = lensReadOnly "Dispatcher" (fun (this : Entity) -> this.GetDispatcher)
        let ModelGeneric<'model> () = lens "Model" (fun (this : Entity) -> this.GetModelGeneric<'model>) (fun value this -> this.SetModelGeneric<'model> value)
        let Ecs = lensReadOnly "Ecs" (fun (this : Entity) -> this.GetEcs)
        let Facets = lensReadOnly "Facets" (fun (this : Entity) -> this.GetFacets)
        let Transform = lens "Transform" (fun (this : Entity) -> this.GetTransform) (fun value this -> this.SetTransform value)
        let PerimeterUnscaled = lens "PerimeterUnscaled" (fun (this : Entity) -> this.GetPerimeterUnscaled) (fun value this -> this.SetPerimeterUnscaled value)
        let Perimeter = lens "Perimeter" (fun (this : Entity) -> this.GetPerimeter) (fun value this -> this.SetPerimeter value)
        let Center = lens "Center" (fun (this : Entity) -> this.GetCenter) (fun value this -> this.SetCenter value)
        let Bottom = lens "Bottom" (fun (this : Entity) -> this.GetBottom) (fun value this -> this.SetBottom value)
        let PerimeterOriented = lensReadOnly "PerimeterOriented" (fun (this : Entity) -> this.GetPerimeterOriented)
        let Bounds = lensReadOnly "Bounds" (fun (this : Entity) -> this.GetBounds)
        let Position = lens "Position" (fun (this : Entity) -> this.GetPosition) (fun value this -> this.SetPosition value)
        let PositionLocal = lens "PositionLocal" (fun (this : Entity) -> this.GetPositionLocal) (fun value this -> this.SetPositionLocal value)
        let Rotation = lens "Rotation" (fun (this : Entity) -> this.GetRotation) (fun value this -> this.SetRotation value)
        let RotationLocal = lens "RotationLocal" (fun (this : Entity) -> this.GetRotationLocal) (fun value this -> this.SetRotationLocal value)
        let Scale = lens "Scale" (fun (this : Entity) -> this.GetScale) (fun value this -> this.SetScale value)
        let ScaleLocal = lens "ScaleLocal" (fun (this : Entity) -> this.GetScaleLocal) (fun value this -> this.SetScaleLocal value)
        let Offset = lens "Offset" (fun (this : Entity) -> this.GetOffset) (fun value this -> this.SetOffset value)
        let Angles = lens "Angles" (fun (this : Entity) -> this.GetAngles) (fun value this -> this.SetAngles value)
        let AnglesLocal = lens "AnglesLocal" (fun (this : Entity) -> this.GetAnglesLocal) (fun value this -> this.SetAnglesLocal value)
        let Degrees = lens "Degrees" (fun (this : Entity) -> this.GetDegrees) (fun value this -> this.SetDegrees value)
        let DegreesLocal = lens "DegreesLocal" (fun (this : Entity) -> this.GetDegreesLocal) (fun value this -> this.SetDegreesLocal value)
        let Size = lens "Size" (fun (this : Entity) -> this.GetSize) (fun value this -> this.SetSize value)
        let Elevation = lens "Elevation" (fun (this : Entity) -> this.GetElevation) (fun value this -> this.SetElevation value)
        let ElevationLocal = lens "ElevationLocal" (fun (this : Entity) -> this.GetElevationLocal) (fun value this -> this.SetElevationLocal value)
        let Overflow = lens "Overflow" (fun (this : Entity) -> this.GetOverflow) (fun value this -> this.SetOverflow value)
        let AffineMatrix = lensReadOnly "AffineMatrix" (fun (this : Entity) -> this.GetAffineMatrix)
        let AffineMatrixLocal = lensReadOnly "AffineMatrixLocal" (fun (this : Entity) -> this.GetAffineMatrixLocal)
        let Presence = lens "Presence" (fun (this : Entity) -> this.GetPresence) (fun value this -> this.SetPresence value)
        let Absolute = lens "Absolute" (fun (this : Entity) -> this.GetAbsolute) (fun value this -> this.SetAbsolute value)
        let MountOpt = lens "MountOpt" (fun (this : Entity) -> this.GetMountOpt) (fun value this -> this.SetMountOpt value)
        let Imperative = lens "Imperative" (fun (this : Entity) -> this.GetImperative) (fun value this -> this.SetImperative value)
        let Enabled = lens "Enabled" (fun (this : Entity) -> this.GetEnabled) (fun value this -> this.SetEnabled value)
        let EnabledLocal = lens "EnabledLocal" (fun (this : Entity) -> this.GetEnabledLocal) (fun value this -> this.SetEnabledLocal value)
        let Visible = lens "Visible" (fun (this : Entity) -> this.GetVisible) (fun value this -> this.SetVisible value)
        let VisibleLocal = lens "VisibleLocal" (fun (this : Entity) -> this.GetVisibleLocal) (fun value this -> this.SetVisibleLocal value)
        let AlwaysUpdate = lens "AlwaysUpdate" (fun (this : Entity) -> this.GetAlwaysUpdate) (fun value this -> this.SetAlwaysUpdate value)
        let Persistent = lens "Persistent" (fun (this : Entity) -> this.GetPersistent) (fun value this -> this.SetPersistent value)
        let Is2d = lensReadOnly "Is2d" (fun (this : Entity) -> this.GetIs2d)
        let Centered = lens "Centered" (fun (this : Entity) -> this.GetCentered) (fun value this -> this.SetCentered value)
        let Static = lens "Static" (fun (this : Entity) -> this.GetStatic) (fun value this -> this.SetStatic value)
        let Light = lens "Light" (fun (this : Entity) -> this.GetLight) (fun value this -> this.SetLight value)
        let Physical = lensReadOnly "Physical" (fun (this : Entity) -> this.GetPhysical)
        let Optimized = lensReadOnly "Optimized" (fun (this : Entity) -> this.GetOptimized)
        let Destroying = lensReadOnly "Destroying" (fun (this : Entity) -> this.GetDestroying)
        let ScriptFrame = lensReadOnly "ScriptFrame" (fun (this : Entity) -> this.GetScriptFrame)
        let OverlayNameOpt = lensReadOnly "OverlayNameOpt" (fun (this : Entity) -> this.GetOverlayNameOpt)
        let FacetNames = lensReadOnly "FacetNames" (fun (this : Entity) -> this.GetFacetNames)
        let Order = lensReadOnly "Order" (fun (this : Entity) -> this.GetOrder)
        let Id = lensReadOnly "Id" (fun (this : Entity) -> this.GetId)
