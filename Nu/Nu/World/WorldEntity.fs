...
module WorldEntityModule =
    ...
    type Entity with
        ...
        member this.Facets = lensReadOnly (nameof this.Facets) this this.GetFacets
        ...
        member this.Transform = lens (nameof this.Transform) this this.GetTransform this.SetTransform
        ...
        member this.PerimeterUnscaled = lens (nameof this.PerimeterUnscaled) this this.GetPerimeterUnscaled this.SetPerimeterUnscaled
        ...
        member this.Perimeter = lens (nameof this.Perimeter) this this.GetPerimeter this.SetPerimeter
        ...
        member this.Center = lens (nameof this.Center) this this.GetCenter this.SetCenter
        ...
        member this.Bottom = lens (nameof this.Bottom) this this.GetBottom this.SetBottom
        member this.GetPerimeterOriented world = World.getEntityPerimeterOriented this world
        member this.PerimeterOriented = lensReadOnly (nameof this.PerimeterOriented) this this.GetPerimeterOriented
        ...
        member this.Rotation = lens (nameof this.Rotation) this this.GetRotation this.SetRotation
        ...
        member this.Offset = lens (nameof this.Offset) this this.GetOffset this.SetOffset
        ...
        member this.Angles = lens (nameof this.Angles) this this.GetAngles this.SetAngles
        ...
        member this.AnglesLocal = lens (nameof this.AnglesLocal) this this.GetAnglesLocal this.SetAnglesLocal
        ...
        member this.Degrees = lens (nameof this.Degrees) this this.GetDegrees this.SetDegrees
        ...
        member this.DegreesLocal = lens (nameof this.DegreesLocal) this this.GetDegreesLocal this.SetDegreesLocal
        ...
        member this.Size = lens (nameof this.Size) this this.GetSize this.SetSize
        ...
        member this.Elevation = lens (nameof this.Elevation) this this.GetElevation this.SetElevation
        ...
        member this.ElevationLocal = lens (nameof this.ElevationLocal) this this.GetElevationLocal this.SetElevationLocal
        ...
        member this.Overflow = lens (nameof this.Overflow) this this.GetOverflow this.SetOverflow
        member this.GetAffineMatrix world = World.getEntityAffineMatrix this world
        member this.AffineMatrix = lensReadOnly (nameof this.AffineMatrix) this this.GetAffineMatrix
        ...
        member this.EnabledLocal = lens (nameof this.EnabledLocal) this this.GetEnabledLocal this.SetEnabledLocal
        ...
        member this.VisibleLocal = lens (nameof this.VisibleLocal) this this.GetVisibleLocal this.SetVisibleLocal
        ...
        member this.AlwaysUpdate = lens (nameof this.AlwaysUpdate) this this.GetAlwaysUpdate this.SetAlwaysUpdate
        ...
        member this.Is2d = lensReadOnly (nameof this.Is2d) this this.GetIs2d
        ...
        member this.Centered = lens (nameof this.Centered) this this.GetCentered this.SetCentered
        ...
        member this.Static = lens (nameof this.Static) this this.GetStatic this.SetStatic
        ...
        member this.Light = lens (nameof this.Light) this this.GetLight this.SetLight
        member this.GetPhysical world = World.getEntityPhysical this world
        member this.Physical = lensReadOnly (nameof this.Physical) this this.GetPhysical
        member this.GetOptimized world = World.getEntityOptimized this world
        member this.Optimized = lensReadOnly (nameof this.Optimized) this this.GetOptimized
        ...
        member this.OverlayNameOpt = lensReadOnly (nameof this.OverlayNameOpt) this this.GetOverlayNameOpt
        member this.GetFacetNames world = World.getEntityFacetNames this world
        member this.FacetNames = lensReadOnly (nameof this.FacetNames) this this.GetFacetNames
