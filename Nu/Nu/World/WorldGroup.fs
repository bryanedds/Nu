...
module WorldGroupModule =
    ...
    type Group with
        ...
        member this.GetActive world = World.getGroupActive this world
        member this.SetActive value world = World.setGroupActive value this world |> ignore<bool>
        member this.Active = lens (nameof this.Active) this this.GetActive this.SetActive
        member this.GetShown world = World.getGroupShown this world
        member this.SetShown value world = World.setGroupShown value this world |> ignore<bool>
        member this.Shown = lens (nameof this.Shown) this this.GetShown this.SetShown
    ...
    type World with
        ...
        static member editGroup lateBindingsPredicate operation (group : Group) world =
            let dispatcher = group.GetDispatcher world
