...
module WorldGroupModule =
    ...
    type Group with
        ...
        member this.SetProtected value world = World.setGroupProtected value this world |> ignore<bool>
        member this.Protected = lens (nameof this.Protected) this this.GetProtected this.SetProtected
