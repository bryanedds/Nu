                ...
                let world =
                    if transitionTime = world.GameTime then
                        ...
                        | Some playSong ->
                            ...
                            | _ -> World.playSong playSong.FadeInTime playSong.FadeOutTime GameTime.zero playSong.Volume playSong.RepeatLimitOpt playSong.Song world // play song when song is different
                        | None -> ()
                        world
                    else world
                match World.getLiveness world with
