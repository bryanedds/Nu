...
module Events =
    ...
    let MouseMiddleChange = stoa<MouseButtonData> "Mouse/Middle/Change/Event"
    let MouseMiddleDown = stoa<MouseButtonData> "Mouse/Middle/Down/Event"
    let MouseMiddleUp = stoa<MouseButtonData> "Mouse/Middle/Up/Event"
