...
module Events =
    ...
    let GamepadDirectionChange index = stoa<GamepadDirectionData> $ "Gamepad/Direction/" + scstring index + "/Change/Event"
    let GamepadButtonChange index = stoa<GamepadButtonData> $ "Gamepad/Button/" + scstring index + "/Change/Event"
    let GamepadButtonDown index = stoa<GamepadButtonData> $ "Gamepad/Button/" + scstring index + "/Down/Event"
    let GamepadButtonUp index = stoa<GamepadButtonData> $ "Gamepad/Button/" + scstring index + "/Up/Event"
