...
module WorldModule4 =
    ...
    type World with
        ...
        static member makePlus
            ...
            let ambientState = AmbientState.make worldConfig.Accompanied worldConfig.TimeAdvancing worldConfig.FramePacing symbolics overlayer timers sdlDepsOpt
            ...
            let worldExtension =
                { ContextImSim = Address.empty
                  ...
                  SimulantJournals = SDictionary.make HashIdentity.Structural
                  SubscriptionJournals = SDictionary.make HashIdentity.Structural
                  JobGraph = jobGraph
