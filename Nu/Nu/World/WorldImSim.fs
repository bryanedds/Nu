...
module WorldImSim =
    ...
    type World with
        ...
        static member doButton name args world =
            let init mapResult (entity : Entity) world = World.monitor (fun _ world -> mapResult tautology world; Cascade) entity.ClickEvent entity world
        ...
        static member doToggleButton name args world =
            let init mapResult (entity : Entity) world = World.monitor (fun _ world -> mapResult tautology world; Cascade) entity.ToggleEvent entity world
        ...
        static member doRadioButton name args world =
            let init mapResult (entity : Entity) world = World.monitor (fun _ world -> mapResult tautology world; Cascade) entity.DialEvent entity world
        ...
        static member doFeeler name args world =
            let init mapResult (entity : Entity) world = World.monitor (fun _ world -> mapResult tautology world; Cascade) entity.TouchEvent entity world
        ...
        static member doTextBox name args world =
            let init mapResult (entity : Entity) world = World.monitor (fun _ world -> mapResult tautology world; Cascade) entity.TextEditEvent entity world
