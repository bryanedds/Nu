...
module WorldModuleEntity =
    ...
    type World with
        ...
        static member readEntity tryReadOrder tryReadPropagationHistory (entityDescriptor : EntityDescriptor) (nameOpt : string option) (parent : Simulant) world =
            ...
            let entityState = Reflection.readFacetNamesToTarget entityProperties entityState
            ...
            let (name, surnames) =
                ...
                | None ->
                    ...
                    | None ->
                        ...
                        (name, surnames)
            let entityState = { entityState with Surnames = surnames } // TODO: P0: consider making this mutable.
