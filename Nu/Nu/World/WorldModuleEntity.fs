...
module WorldModuleEntity =
    ...
    type World with
        ...
        static member internal tryGetEntityXtensionValue<'a> propertyName entity world : 'a option =
            try World.getEntityXtensionValue<'a> propertyName entity world |> Some
