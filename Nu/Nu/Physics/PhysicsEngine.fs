...
type PhysicsEngine =
    ...
    abstract GetFluidExists : fluidEmitterId : FluidEmitterId -> bool
    
    /// Check that the fluid with the given fluid emitter id is on the ground.
    abstract GetFluidGrounded : fluidEmitterId : FluidEmitterId -> bool
...
type [<ReferenceEquality>] StubPhysicsEngine =
    ...
    interface PhysicsEngine with
        ...
        member physicsEngine.GetFluidExists _ = failwith "No fluid emitters in StubPhysicsEngine"
        member physicsEngine.GetFluidGrounded _ = failwith "No fluid emitters in StubPhysicsEngine"
