...
module AssetPatterns =
    ...
    let (|SpineSkeletonExtension|_|) extension = match extension with ".json" -> Some extension | _ -> None
...
module Assets =
    ...
    module Default =
        ...
        let [<Literal>] SpineSkeletonName = "dragon-ess" // TODO: P0: see if we can rename this files to SpineSkeleton.
