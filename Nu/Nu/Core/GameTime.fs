...
and [<Struct; CustomEquality; CustomComparison; TypeConverter (typeof<GameTimeConverter>)>] GameTime =
    ...
    static member (/) (left, right) = GameTime.ap (/) (/) left right
    static member (%) (left, right) = GameTime.ap (%) (%) left right
    static member (+) (left, right) = GameTime.unary ((+) right >> UpdateTime) (flip (+) right >> TickTime) left
    static member (-) (left, right) = GameTime.unary ((-) right >> UpdateTime) (flip (-) right >> TickTime) left
    static member (*) (left, right) = GameTime.unary ((*) right >> UpdateTime) (flip (*) right >> TickTime) left
    static member (/) (left, right) = GameTime.unary ((/) right >> UpdateTime) (flip (/) right >> TickTime) left
    static member (%) (left, right) = GameTime.unary ((%) right >> UpdateTime) (flip (%) right >> TickTime) left
    static member (+) (left, right) = GameTime.unary ((+) left >> UpdateTime) ((+) left >> TickTime) right
    static member (-) (left, right) = GameTime.unary ((-) left >> UpdateTime) ((-) left >> TickTime) right
    static member (*) (left, right) = GameTime.unary ((*) left >> UpdateTime) ((*) left >> TickTime) right
    static member (/) (left, right) = GameTime.unary ((/) left >> UpdateTime) ((/) left >> TickTime) right
    static member (%) (left, right) = GameTime.unary ((%) left >> UpdateTime) ((%) left >> TickTime) right
