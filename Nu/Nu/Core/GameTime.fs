...
and [<Struct; CustomEquality; CustomComparison; TypeConverter (typeof<GameTimeConverter>)>] GameTime =
    ...
    static member (/) (left, right) = GameTime.ap (/) (/) left right
    static member (%) (left, right) = GameTime.ap (%) (%) left right
    static member (+) (left, right : int64) = GameTime.unary ((+) right >> UpdateTime) (flip (+) (single right * single Stopwatch.Frequency |> int64) >> TickTime) left
    static member (-) (left, right : int64) = GameTime.unary ((-) right >> UpdateTime) (flip (-) (single right * single Stopwatch.Frequency |> int64) >> TickTime) left
    static member (*) (left, right : int64) = GameTime.unary ((*) right >> UpdateTime) (flip (*) (single right * single Stopwatch.Frequency |> int64) >> TickTime) left
    static member (/) (left, right : int64) = GameTime.unary ((/) right >> UpdateTime) (flip (/) (single right * single Stopwatch.Frequency |> int64) >> TickTime) left
    static member (%) (left, right : int64) = GameTime.unary ((%) right >> UpdateTime) (flip (%) (single right * single Stopwatch.Frequency |> int64) >> TickTime) left
    static member (+) (left : int64, right) = GameTime.unary ((+) left >> UpdateTime) ((+) (single left * single Stopwatch.Frequency |> int64) >> TickTime) right
    static member (-) (left : int64, right) = GameTime.unary ((-) left >> UpdateTime) ((-) (single left * single Stopwatch.Frequency |> int64) >> TickTime) right
    static member (*) (left : int64, right) = GameTime.unary ((*) left >> UpdateTime) ((*) (single left * single Stopwatch.Frequency |> int64) >> TickTime) right
    static member (/) (left : int64, right) = GameTime.unary ((/) left >> UpdateTime) ((/) (single left * single Stopwatch.Frequency |> int64) >> TickTime) right
    static member (%) (left : int64, right) = GameTime.unary ((%) left >> UpdateTime) ((%) (single left * single Stopwatch.Frequency |> int64) >> TickTime) right
    static member (+) (left, right : single) = GameTime.unary ((+) (int64 right) >> UpdateTime) (flip (+) (right * single Stopwatch.Frequency |> int64) >> TickTime) left
    static member (-) (left, right : single) = GameTime.unary ((-) (int64 right) >> UpdateTime) (flip (-) (right * single Stopwatch.Frequency |> int64) >> TickTime) left
    static member (*) (left, right : single) = GameTime.unary ((*) (int64 right) >> UpdateTime) (flip (*) (right * single Stopwatch.Frequency |> int64) >> TickTime) left
    static member (/) (left, right : single) = GameTime.unary ((/) (int64 right) >> UpdateTime) (flip (/) (right * single Stopwatch.Frequency |> int64) >> TickTime) left
    static member (%) (left, right : single) = GameTime.unary ((%) (int64 right) >> UpdateTime) (flip (%) (right * single Stopwatch.Frequency |> int64) >> TickTime) left
    static member (+) (left : single, right) = GameTime.unary ((+) (int64 left) >> UpdateTime) ((+) (left * single Stopwatch.Frequency |> int64) >> TickTime) right
    static member (-) (left : single, right) = GameTime.unary ((-) (int64 left) >> UpdateTime) ((-) (left * single Stopwatch.Frequency |> int64) >> TickTime) right
    static member (*) (left : single, right) = GameTime.unary ((*) (int64 left) >> UpdateTime) ((*) (left * single Stopwatch.Frequency |> int64) >> TickTime) right
    static member (/) (left : single, right) = GameTime.unary ((/) (int64 left) >> UpdateTime) ((/) (left * single Stopwatch.Frequency |> int64) >> TickTime) right
    static member (%) (left : single, right) = GameTime.unary ((%) (int64 left) >> UpdateTime) ((%) (left * single Stopwatch.Frequency |> int64) >> TickTime) right
