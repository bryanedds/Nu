...
module Render =
    ...
    let [<Literal>] SsrRefinements = 17;
    let [<Literal>] SsrRoughnessMax = 0.5f;
    let [<Literal>] SsrSurfaceSlopeMax = 0.1f;
    let [<Literal>] SsrRayThicknessMarch = 0.05f;
    let [<Literal>] SsrRayThicknessRefinement = 0.02f;
    let [<Literal>] SsrFilterCutoff = 0.8f;
    let [<Literal>] SsrEdgeCutoffHorizontal = 0.05f;
    let [<Literal>] SsrEdgeCutoffVertical = 0.2f;
