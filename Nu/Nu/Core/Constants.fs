...
module Render =
    ...
    let [<Literal>] SsaoRadiusDefault = 0.125f // 8x this for outside scenes
...
module Physics =
    ...
    let [<Literal>] AllowedCcdPenetration3d = 0.01f // NOTE: along with AxisSweep3 broadphase, seems to keep characters from falling through terrain.
