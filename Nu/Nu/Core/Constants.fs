...
module Render =
    ...
    let [<Uniform>] mutable ShadowCascadeMarginRatioCull = match ConfigurationManager.AppSettings.["ShadowCascadeMarginRatioCull"] with null -> 0.25f | value -> scvalue value
