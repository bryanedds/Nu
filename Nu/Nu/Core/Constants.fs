...
module Engine =
    ...
    let (*Literal*) Entity2dSizeDefault = Vector3 (48.0f, 48.0f, 0.0f)
    let (*Literal*) EntityGuiSizeDefault = Vector3 (192.0f, 48.0f, 0.0f)
    let (*Literal*) Entity3dSizeDefault = Vector3 1.0f
    let (*Literal*) Particle2dSizeDefault = Vector3 (12.0f, 12.0f, 0.0f)
    let (*Literal*) Particle3dSizeDefault = Vector3 (0.01f, 0.01f, 0.01f)
    let (*Literal*) Eye3dPositionDefault = Vector3 (0.0f, 1.0f, 4.0f)
...
module Render =
    ...
    let (*Literal*) PlayBox3dSize = Vector3 200.0f
    let (*Literal*) LightBox3dSize = Vector3 400.0f
