...
module Render =
    ...
    let [<Uniform>] Light3dBoxSize = Vector3 256.0f
    ...
    let [<Uniform>] ShadowResolutionX = 4096 * VirtualScalar
    let [<Uniform>] ShadowResolutionY = 4096 * VirtualScalar
