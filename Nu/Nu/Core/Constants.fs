...
module Paths =
    ...
    let [<Literal>] FilterGaussian1dShaderFilePath = "Assets/Default/FilterGaussian1d"
    let [<Literal>] FilterGaussianArray1dShaderFilePath = "Assets/Default/FilterGaussianArray1d"
