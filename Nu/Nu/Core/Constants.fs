...
module Render =
    ...
    let [<Uniform>] ShadowCascadeOverflow = match ConfigurationManager.AppSettings.["ShadowCascadeOverflow"] with null -> 1.5f | value -> scvalue value // TODO: P0: place this in lighting config?
