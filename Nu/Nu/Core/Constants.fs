...
module Render =
    ...
    let [<Literal>] SsrDetailDefault = 0.34f;
    let [<Literal>] SsrDepthMaxDefault = 24.0f;
    let [<Literal>] SsrDistanceMaxDefault = 24.0f;
    let [<Literal>] SsrRefinementsMaxDefault = 17;
    let [<Literal>] SsrRoughnessMaxDefault = 0.5f;
    let [<Literal>] SsrSurfaceSlopeMaxDefault = 0.1f;
    let [<Literal>] SsrRayThicknessMarchDefault = 0.05f;
    let [<Literal>] SsrRayThicknessRefinementDefault = 0.02f;
    let [<Literal>] SsrFilterCutoffDefault = 0.8f;
    let [<Literal>] SsrEdgeCutoffHorizontalDefault = 0.05f;
    let [<Literal>] SsrEdgeCutoffVerticalDefault = 0.2f;
    let [<Uniform>] SsrAmbientLightColorDefault = Color.White;
