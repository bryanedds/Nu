...
module Render =
    ...
    let [<Uniform>] mutable TextureCompressionType = match ConfigurationManager.AppSettings.["TextureCompressionType"] with null -> BcCompressionType | value -> scvalue value
