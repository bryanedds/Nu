...
module Render =
    ...
    let (*Literal*) FarPlaneDistanceEnclosed = 150.0f
    let (*Literal*) FarPlaneDistanceUnenclosed = 300.0f
    let (*Literal*) FarPlaneDistanceAfatecs = 3200.0f // ~2 miles
    let (*Literal*) FarPlaneDistanceOmnipresent = 160000.0f // ~10 miles
    let (*Literal*) PlayBoxSize3d = Vector3 150.0f
    let (*Literal*) LightBoxSize3d = Vector3 300.0f
