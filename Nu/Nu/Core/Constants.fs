...
module Render =
    ...
    let [<Literal>] SsrlEdgeVerticalMarginDefault = 0.2f
...
module Paths =
    ...
    let [<Literal>] FilterBloomSeparateFilePath = "Assets/Default/FilterBloomSeparate.glsl"
    ...
    let [<Literal>] FilterBloomCompositeShaderFilePath = "Assets/Default/FilterBloomComposite.glsl"
