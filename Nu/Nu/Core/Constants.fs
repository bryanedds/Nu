...
module Render =
    ...
    let [<Literal>] TerrainLayersMax = 6 // TODO: ensure this constant is in the right order in this module.
    let [<Literal>] BonesMax = 96 // TODO: ensure this constant is in the right order in this module.
    let [<Literal>] BonesInfluenceMax = 4 // TODO: ensure this constant is in the right order in this module.
    ...
    let [<Literal>] SsaoIntensityDefault = 2.0f
