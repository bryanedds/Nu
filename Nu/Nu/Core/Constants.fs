...
module Render =
    ...
    let [<Literal>] SsrDetailDefault = 0.3f
    ...
    let [<Literal>] SsrRoughnessFilterCutoffDefault = 0.5f
    let [<Literal>] SsrDepthFilterCutoffDefault = 0.2f
    let [<Literal>] SsrDistanceFilterCutoffDefault = 0.2f
