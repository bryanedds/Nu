...
module Engine =
    ...
    let [<Uniform>] QuadtreeDepth = 8
    let [<Uniform>] QuadtreeSize = Vector2 131072.0f // about 1 3/4 miles
    let [<Uniform>] OctreeDepth = 8
...
module Render =
    ...
    let [<Literal>] FarPlaneDistanceEnclosed = 25.0f
    let [<Literal>] NearPlaneDistanceExposed = FarPlaneDistanceEnclosed
    let [<Literal>] FarPlaneDistanceExposed = 100.0f
    let [<Literal>] NearPlaneDistanceImposter = FarPlaneDistanceExposed
    let [<Literal>] FarPlaneDistanceImposter = 400.0f
    ...
    let [<Uniform>] PlayBoxSize3d = Vector3 100.0f
    let [<Uniform>] LightBoxSize3d = Vector3 100.0f
