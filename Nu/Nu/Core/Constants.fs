...
module Paths =
    ...
    let [<Literal>] FilterDownSampleBilateral4dShaderFilePath = "Assets/Default/FilterDownSampleBilateral4d.glsl"
    let [<Literal>] FilterUpSampleBilateral4dShaderFilePath = "Assets/Default/FilterUpSampleBilateral4d.glsl"
