...
module Paths =
    ...
    let [<Literal>] FilterGaussian1dShaderFilePath = "Assets/Default/FilterGaussian1d.glsl"
    let [<Literal>] FilterGaussianArray1dShaderFilePath = "Assets/Default/FilterGaussianArray1d.glsl"
