...
module Engine =
    ...
    let [<Uniform>] EntitySize2dDefault = Vector3 (32.0f, 32.0f, 0.0f)
    let [<Uniform>] EntitySizeGuiDefault = Vector3 (128.0f, 32.0f, 0.0f)
    let [<Uniform>] EntitySize3dDefault = Vector3 (1.0f, 1.0f, 1.0f)
    let [<Uniform>] EntitySizeVuiDefault = Vector3 (4.0f, 1.0f, 1.0f)
    let [<Uniform>] ParticleSize2dDefault = Vector3 (128.0f, 32.0f, 0.0f)
    let [<Uniform>] ParticleSize3dDefault = Vector3 (0.25f, 0.25f, 0.25f)
