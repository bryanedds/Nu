...
module Render =
    ...
    let [<Literal>] ShadowCascadesMax = 2 // NOTE: remember to update SHADOW_TEXTURES_MAX in shaders when changing this!
    let [<Literal>] ShadowCascadeLevels = 3 // NOTE: remember to update SHADOW_MAP_SIZE in shaders when changing this!
