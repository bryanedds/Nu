...
module WorldLayerModule =
    ...
    type Layer with
        ...
        member internal this.GetScriptFrameNp world = World.getLayerScriptFrameNp this world
        member internal this.SetScriptFrameNp value world = World.setLayerScriptFrameNp value this world
        member internal this.ScriptFrameNp = PropertyTag.make this Property? Script this.GetScriptFrameNp this.SetScriptFrameNp
