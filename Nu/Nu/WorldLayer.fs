...
module WorldLayerModule =
    ...
    type Layer with
        ...
        member this.Name = Lens.makeReadOnly this Property? Name this.GetName
        ...
        member this.Persistent = Lens.make this Property? Persistent this.GetPersistent this.SetPersistent
        ...
        member this.Depth = Lens.make this Property? Depth this.GetDepth this.SetDepth
        ...
        member this.Visible = Lens.make this Property? Visible this.GetVisible this.SetVisible
