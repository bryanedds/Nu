...
module WorldLayerModule =
    ...
    type Layer with
        ...
        member this.GetScriptFramesNp world = World.getLayerScriptFramesNp this world
        member this.SetScriptFramesNp value world = World.setLayerScriptFramesNp value this world
